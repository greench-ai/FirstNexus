...
# Output:
# - dist/FirstNexus.app
# - dist/FirstNexus-<version>.zip
# - dist/FirstNexus-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.FirstNexus.mac}"
...
APP="$ROOT_DIR/dist/FirstNexus.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FirstNexus-$VERSION.zip"
DMG="$ROOT_DIR/dist/FirstNexus-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FirstNexus-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FirstNexus-$VERSION.dSYM.zip"
