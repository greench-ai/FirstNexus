...
# Output:
# - dist/NexusClaw.app
# - dist/NexusClaw-<version>.zip
# - dist/NexusClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.nexusclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/NexusClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/NexusClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/NexusClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/NexusClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/NexusClaw-$VERSION.dSYM.zip"
