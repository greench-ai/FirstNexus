...
script_path="${NEXISCLAW_RELEASE_CHECKS_SCRIPT:-workflow/scripts/FirstNexus-cross-os-release-checks.ts}"
...
tool_dir="${NEXISCLAW_RELEASE_TSX_TOOL_DIR:-${temp_root}/FirstNexus-release-tsx-${tsx_version}}"
