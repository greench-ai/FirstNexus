...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']nexusclaw\/plugin-sdk["']/,
    hint: "Use nexusclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']nexusclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use nexusclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']nexusclaw\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or nexusclaw/plugin-sdk/testing for public surfaces.",
  },
  {
