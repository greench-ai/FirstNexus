...
NEXISCLAW_DOCKER_BUILD_USE_BUILDX="${NEXISCLAW_DOCKER_BUILD_USE_BUILDX:-0}"
NEXISCLAW_DOCKER_BUILD_CACHE_FROM="${NEXISCLAW_DOCKER_BUILD_CACHE_FROM:-}"
NEXISCLAW_DOCKER_BUILD_CACHE_TO="${NEXISCLAW_DOCKER_BUILD_CACHE_TO:-}"
