...
IMAGE_NAME="$(docker_e2e_resolve_image "FirstNexus-commitments-safety-e2e" NEXISCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="FirstNexus-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t FirstNexus-commitments-safety-log.XXXXXX)"
