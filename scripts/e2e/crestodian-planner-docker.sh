...
IMAGE_NAME="$(docker_e2e_resolve_image "FirstNexus-crestodian-planner-e2e" NEXISCLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="FirstNexus-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t FirstNexus-crestodian-planner-log.XXXXXX)"
...
NEXISCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
