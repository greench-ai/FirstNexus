...
IMAGE_NAME="$(docker_e2e_resolve_image "FirstNexus-session-runtime-context-e2e" NEXISCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="FirstNexus-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t FirstNexus-session-runtime-context-log.XXXXXX)"
