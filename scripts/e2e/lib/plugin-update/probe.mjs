...
const pluginRecordSnapshot = () => {
  const config = readJson(FirstNexusPath("FirstNexus.json"));
...
function seedInstallState() {
  writeJson(FirstNexusPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.NEXISCLAW_CONFIG_PATH, { plugins: {} });
  writeJson(FirstNexusPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by FirstNexus plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("FirstNexus will continue without it")
  );
}
