...
FirstNexus_e2e_install_package /tmp/FirstNexus-plugin-lifecycle-install.log "mounted FirstNexus package" /tmp/npm-prefix
...
pack_root="$(mktemp -d "/tmp/FirstNexus-plugin-lifecycle-pack.XXXXXX")"
registry_root="$(mktemp -d "/tmp/FirstNexus-plugin-lifecycle-registry.XXXXXX")"
