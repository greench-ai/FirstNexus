...
demo_plugin_root="$NEXISCLAW_PLUGIN_HOME/$demo_plugin_id"
write_demo_fixture_plugin "$demo_plugin_root"
record_fixture_plugin_trust "$demo_plugin_id" "$demo_plugin_root" 1

node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin --runtime --json >/tmp/plugins-inspect.json
...
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins2.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin-tgz --runtime --json >/tmp/plugins2-inspect.json

node scripts/e2e/lib/plugins/assertions.mjs plugin-tgz

run_logged uninstall-tgz node "$NEXISCLAW_ENTRY" plugins uninstall demo-plugin-tgz --force
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins2-uninstalled.json
...
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins3.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin-dir --runtime --json >/tmp/plugins3-inspect.json

node scripts/e2e/lib/plugins/assertions.mjs plugin-dir "$dir_plugin"

node "$NEXISCLAW_ENTRY" plugins update demo-plugin-dir >/tmp/plugins-dir-update.log 2>&1
node scripts/e2e/lib/plugins/assertions.mjs plugin-dir-update-skipped

run_logged uninstall-dir node "$NEXISCLAW_ENTRY" plugins uninstall demo-plugin-dir --force
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins3-uninstalled.json
...
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-dir-deps.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin-dir-deps --runtime --json >/tmp/plugins-dir-deps-inspect.json

node scripts/e2e/lib/plugins/assertions.mjs plugin-dir-deps "$dir_deps_plugin"

run_logged uninstall-dir-deps node "$NEXISCLAW_ENTRY" plugins uninstall demo-plugin-dir-deps --force
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-dir-deps-uninstalled.json
...
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins4.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin-file --runtime --json >/tmp/plugins4-inspect.json

node scripts/e2e/lib/plugins/assertions.mjs plugin-file "$file_pack_dir/package"

run_logged uninstall-file node "$NEXISCLAW_ENTRY" plugins uninstall demo-plugin-file --force
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins4-uninstalled.json
...
node "$NEXISCLAW_ENTRY" plugins update demo-plugin-npm >/tmp/plugins-npm-update.log 2>&1
node scripts/e2e/lib/plugins/assertions.mjs plugin-npm-update

run_logged uninstall-npm node "$NEXISCLAW_ENTRY" plugins uninstall demo-plugin-npm --force
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-npm-uninstalled.json
...
run_logged install-git node "$NEXISCLAW_ENTRY" plugins install "git:$git_repo_url@$git_ref"
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-git.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin-git --runtime --json >/tmp/plugins-git-inspect.json
run_logged exec-git-plugin-cli bash -c 'node "$NEXISCLAW_ENTRY" demo-git ping >/tmp/plugins-git-cli.txt'

node scripts/e2e/lib/plugins/assertions.mjs plugin-git "$git_repo_url" "$git_ref"

run_logged uninstall-git node "$NEXISCLAW_ENTRY" plugins uninstall demo-plugin-git --force
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-git-uninstalled.json
...
run_logged install-git-update node "$NEXISCLAW_ENTRY" plugins install "git:$git_update_repo_url@main"
...
node "$NEXISCLAW_ENTRY" plugins update demo-plugin-git-update >/tmp/plugins-git-update.log 2>&1
node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-git-update.json
node "$NEXISCLAW_ENTRY" plugins inspect demo-plugin-git-update --runtime --json >/tmp/plugins-git-update-inspect.json
run_logged exec-updated-git-plugin-cli bash -c 'node "$NEXISCLAW_ENTRY" demo-git-update ping >/tmp/plugins-git-update-cli.txt'
...
bundle_root="$NEXISCLAW_PLUGIN_HOME/$bundle_plugin_id"
write_claude_bundle_fixture "$bundle_root"
record_fixture_plugin_trust "$bundle_plugin_id" "$bundle_root" 0

node "$NEXISCLAW_ENTRY" plugins list --json >/tmp/plugins-bundle-disabled.json
node scripts/e2e/lib/plugins/assertions.mjs bundle-disabled

run_logged enable-claude-bundle node "$NEXISCLAW_ENTRY" plugins enable claude-bundle-e2e
node "$NEXISCLAW_ENTRY" plugins inspect claude-bundle-e2e --json >/tmp/plugins-bundle-inspect.json
...
node "$NEXISCLAW_ENTRY" plugins inspect slash-install-plugin --runtime --json >/tmp/plugin-command-install-show.json
