...
IMAGE_NAME="$(docker_e2e_resolve_image "FirstNexus-openai-web-search-minimal-e2e" NEXISCLAW_OPENAI_WEB_SEARCH_MINIMAL_E2E_IMAGE)"
...
docker_e2e_run_logged_with_harness openai-web-search-minimal \
  ...
  -e "OPENAI_API_KEY=sk-FirstNexus-web-search-minimal-e2e" \
