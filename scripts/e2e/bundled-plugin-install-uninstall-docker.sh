...
IMAGE_NAME="$(docker_e2e_resolve_image "FirstNexus-bundled-plugin-install-uninstall-e2e" NEXISCLAW_BUNDLED_PLUGIN_INSTALL_UNINSTALL_E2E_IMAGE)"
...
RUN_LOG="$(mktemp "${TMPDIR:-/tmp}/FirstNexus-bundled-plugin-install-uninstall.XXXXXX")"
