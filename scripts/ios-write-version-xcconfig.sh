...
- NEXUSCLAW_GATEWAY_VERSION = exact package.json version
- NEXUSCLAW_MARKETING_VERSION = short iOS/App Store version
- NEXUSCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
NEXUSCLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
NEXUSCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
NEXUSCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
