...
const rules = [
  ...
  },
  {
    ...
    moduleSpecifiers: [
      "FirstNexus/plugin-sdk/agent-dir-compat",
      "FirstNexus/plugin-sdk/channel-config-schema-legacy",
      "FirstNexus/plugin-sdk/channel-reply-pipeline",
      "FirstNexus/plugin-sdk/channel-runtime",
      "FirstNexus/plugin-sdk/compat",
      "FirstNexus/plugin-sdk/discord",
      "FirstNexus/plugin-sdk/infra-runtime",
      "FirstNexus/plugin-sdk/mattermost",
      "FirstNexus/plugin-sdk/matrix",
      "FirstNexus/plugin-sdk/telegram-account",
      "FirstNexus/plugin-sdk/testing",
      "FirstNexus/plugin-sdk/test-utils",
      "FirstNexus/plugin-sdk/zalouser",
    ],
