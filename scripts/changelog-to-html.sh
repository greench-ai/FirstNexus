...
if [[ -z "$version_content" ]]; then
  echo "<h2>FirstNexus $VERSION</h2>"
  echo "<p>Latest FirstNexus update.</p>"
  echo "<p><a href=\"https://github.com/FirstNexus/FirstNexus/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
