...
if [[ -z "$version_content" ]]; then
  echo "<h2>NexusClaw $VERSION</h2>"
  echo "<p>Latest NexusClaw update.</p>"
  echo "<p><a href=\"https://github.com/nexusclaw/nexusclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
