...
show_usage() {
    cat << EOF
clawlog - NexusClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View NexusClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    NexusClaw logs flow through the macOS unified log (subsystem: ai.nexusclaw).
