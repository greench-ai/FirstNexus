...
show_usage() {
    cat << EOF
clawlog - FirstNexus Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View FirstNexus logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    FirstNexus logs flow through the macOS unified log (subsystem: ai.FirstNexus).
