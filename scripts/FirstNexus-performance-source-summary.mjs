...
function printHelp() {
  console.log(`Usage: node scripts/FirstNexus-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes FirstNexus-native performance probe artifacts for CI reports.`);
}
