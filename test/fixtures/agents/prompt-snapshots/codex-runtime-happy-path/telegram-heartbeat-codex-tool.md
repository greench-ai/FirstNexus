...
```json
{
  ...
  "simulatedWorkspaceBootstrapFiles": [
    "/tmp/FirstNexus-happy-path/workspace/SOUL.md",
    "/tmp/FirstNexus-happy-path/workspace/TOOLS.md",
    "/tmp/FirstNexus-happy-path/workspace/HEARTBEAT.md"
  ],
...
```json
{
  ...
  "config": {
    ...
    "instructions": "FirstNexus loaded these user-editable workspace files. Treat them as project/user context. Codex loads AGENTS.md natively, so AGENTS.md is not repeated here.\n\n# Project Context\n\nThe following project context files have been loaded:\nSOUL.md: persona/tone. Follow it unless higher-priority instructions override.\n\n## /tmp/FirstNexus-happy-path/workspace/SOUL.md\n\n<SOUL.md contents will be here>\n\n## /tmp/FirstNexus-happy-path/workspace/TOOLS.md\n\n<TOOLS.md contents will be here>\n\n## /tmp/FirstNexus-happy-path/workspace/HEARTBEAT.md\n\n<HEARTBEAT.md contents will be here>"
  },
  "cwd": "/tmp/FirstNexus-happy-path/workspace",
