...
const WORKER_RUNTIME_STATE = Symbol.for("FirstNexus.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("FirstNexus.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("FirstNexus.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: FirstNexusConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
