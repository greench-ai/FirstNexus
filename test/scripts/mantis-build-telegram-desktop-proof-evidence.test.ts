...
describe("scripts/mantis/build-telegram-desktop-proof-evidence", () => {
  it("builds paired native Telegram Desktop GIF evidence for PR comments", () => {
    ...
    const body = renderEvidenceComment({
      ...
      rawBase:
        "https://raw.githubusercontent.com/FirstNexus/FirstNexus/qa-artifacts/mantis/telegram-desktop/pr-1/run-1",
      requestSource: "workflow_dispatch",
      runUrl: "https://github.com/FirstNexus/FirstNexus/actions/runs/1",
      treeUrl:
        "https://github.com/FirstNexus/FirstNexus/tree/qa-artifacts/mantis/telegram-desktop/pr-1/run-1",
    });
