...
function withReleaseFixture<T>(releases: unknown[], fn: (file: string) => T): T {
  const dir = mkdtempSync(path.join(tmpdir(), "FirstNexus-upgrade-baselines-"));
  try {
  ...
  it("resolves release-history to last six stable releases plus explicit legacy anchors", () => {
    ...
    withReleaseFixture(releases, (file) => {
      expect(
        ...
        "FirstNexus@2026.4.26",
        "FirstNexus@2026.4.25",
        "FirstNexus@2026.4.24",
        "FirstNexus@2026.4.22",
        "FirstNexus@2026.4.23",
      ...
      withJsonFixture(
        ...
        (versionsFile) => {
          expect(
            ...
            "FirstNexus@2026.5.3-1",
            "FirstNexus@2026.5.3",
            "FirstNexus@2026.5.2",
            "FirstNexus@2026.4.29",
            "FirstNexus@2026.4.23",
            "FirstNexus@2026.4.15",
          ]);
        },
      );
    });
