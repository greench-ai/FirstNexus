...
const WORKFLOW_PATH = ".github/workflows/FirstNexus-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-FirstNexus-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-FirstNexus-cross-os-release-checks.sh";
