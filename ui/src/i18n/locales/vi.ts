...
export const vi: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Chỉnh sửa FirstNexus.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Đang dùng di động? Sao chép URL đầy đủ (bao gồm #token=...) từ FirstNexus dashboard --no-open trên máy tính của bạn.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — xác thực lại bằng FirstNexus models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Dán token từ FirstNexus dashboard --no-open hoặc nhập mật khẩu đã cấu hình.",
        stepGenerate:
          "Nếu chưa cấu hình token, hãy chạy FirstNexus doctor --generate-gateway-token trên máy chủ Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Chạy FirstNexus dashboard --no-open rồi mở URL mới hoặc dán token của nó.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Chạy FirstNexus devices list trên máy chủ Gateway.",
        stepApproveId: "Phê duyệt yêu cầu này: FirstNexus devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Mở lại dashboard được phục vụ bằng FirstNexus dashboard để UI và Gateway đến từ cùng một bản cài đặt.",
        stepDevUi:
          "Nếu dùng pnpm ui:dev, hãy build lại hoặc khởi động lại UI dev theo checkout hiện tại.",
        stepRestart:
          "Khởi động lại Gateway sau khi cập nhật FirstNexus để nó phục vụ giao thức hiện tại.",
      },
      network: {
        ...
        stepGateway:
          "Xác nhận Gateway đang chạy bằng FirstNexus status hoặc FirstNexus gateway run.",
        stepUrl: "Kiểm tra WebSocket URL và dùng wss:// khi Gateway nằm sau HTTPS/Tailscale Serve.",
        stepDashboard:
          "Mở lại dashboard bằng FirstNexus dashboard --no-open để sao chép lại URL và chi tiết auth hiện tại.",
      },
    },
  },
  chat: {
