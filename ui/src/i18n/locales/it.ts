...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Modifica FirstNexus.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Su mobile? Copia l'URL completo (incluso #token=...) da FirstNexus dashboard --no-open sul desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — riautenticati con FirstNexus models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da FirstNexus dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui FirstNexus doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui FirstNexus dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui FirstNexus devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: FirstNexus devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con FirstNexus dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato FirstNexus affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con FirstNexus status o FirstNexus gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con FirstNexus dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  chat: {
