...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/FirstNexus");
      expect(html).toContain('<a href="http://github.com/FirstNexus"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[FirstNexus中文](https://docs.FirstNexus.ai)");
      expect(html).toContain('href="https://docs.FirstNexus.ai"');
      expect(html).toContain("FirstNexus中文</a>");
    });
