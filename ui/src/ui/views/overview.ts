...
export function renderOverview(props: OverviewProps) {
      ...
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ${pairingState.requestId
            ? html`<span class="mono">FirstNexus devices approve ${pairingState.requestId}</span
                ><br />`
            : nothing}
          <span class="mono">FirstNexus devices list</span>
        </div>
        <div style="margin-top: 6px; font-size: 12px;">${t("overview.pairing.mobileHint")}</div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.FirstNexus.ai/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">FirstNexus dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">FirstNexus doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.FirstNexus.ai/web/dashboard"
              target=${EXTERNAL_LINK_TARGET}
              rel=${buildExternalLinkRel()}
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "FirstNexus dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.FirstNexus.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.FirstNexus.ai/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.FirstNexus.ai/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
              ...
              <div class="login-gate__help" style="margin-top: 16px;">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ...
                    ${renderConnectCommand("FirstNexus gateway run")}
                  </li>
                  <li>
                    ${t("overview.connection.step2")}
                    ${renderConnectCommand("FirstNexus dashboard")}
                  </li>
                  <li>${t("overview.connection.step3")}</li>
                  <li>
                    ${t("overview.connection.step4")}<code
                      >FirstNexus doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
