...
describe("tool-card extraction", () => {
  ...
  it("extracts canvas handle payloads into canvas previews", () => {
    const [card] = extractToolCards(
      {
        ...
        content: JSON.stringify({
          ...
          view: {
            backend: "canvas",
            id: "cv_inline",
            url: "/__FirstNexus__/canvas/documents/cv_inline/index.html",
          },
          presentation: {
    ...
    expect(card?.preview?.url).toBe("/__FirstNexus__/canvas/documents/cv_inline/index.html");
    ...
    const cases = [
      {
        ...
        content: JSON.stringify({
          ...
          view: {
            backend: "canvas",
            id: "cv_tool_card",
            url: "/__FirstNexus__/canvas/documents/cv_tool_card/index.html",
          },
          presentation: {
            target: "tool_card",
