...
- use `pnpm FirstNexus qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the FirstNexus QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this FirstNexus repo from source + docs before acting.
