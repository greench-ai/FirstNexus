...
execution:
  ...
  config:
    firstPrompt: "@FirstNexus Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@FirstNexus Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
