...
- Code: `.agents/skills/FirstNexus-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/FirstNexus-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
