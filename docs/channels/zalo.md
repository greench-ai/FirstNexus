...
Zalo ships as a bundled plugin in current FirstNexus releases, so normal packaged
...
- Install via CLI: `FirstNexus plugins install @FirstNexus/zalo`
- Pinned version: `FirstNexus plugins install @FirstNexus/zalo@2026.5.2`
- Or from a source checkout: `FirstNexus plugins install ./path/to/local/zalo-plugin`
...
This page reflects current FirstNexus behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `FirstNexus pairing list zalo`
  - `FirstNexus pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in FirstNexus.
...
- Example: `FirstNexus message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `FirstNexus channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `FirstNexus logs --follow`
