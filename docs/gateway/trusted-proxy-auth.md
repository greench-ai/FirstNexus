...
- Internal Gateway clients that do not travel through the reverse proxy should use `gateway.auth.password` / `NEXISCLAW_GATEWAY_PASSWORD`, not trusted-proxy identity headers.
