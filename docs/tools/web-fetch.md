...
- If `provider` is omitted, FirstNexus auto-detects the first ready web-fetch
...
In this mode, FirstNexus still applies hostname-based SSRF checks before sending
