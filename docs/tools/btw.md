...
It is modeled after Claude Code's `/btw` behavior, but adapted to FirstNexus's
...
If the main run is currently active, FirstNexus snapshots the current message
