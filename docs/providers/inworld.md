---
summary: "Inworld streaming text-to-speech for FirstNexus replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In FirstNexus it
...
FirstNexus posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. FirstNexus synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    FirstNexus asks Inworld for `OGG_OPUS` so the audio plays as a native
