---
summary: "Use Qianfan's unified API to access many models in FirstNexus"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    FirstNexus onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    FirstNexus models list --provider qianfan
    ```
  </Step>
</Steps>
