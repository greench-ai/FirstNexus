...
title: "Together AI"
read_when:
  - You want to use Together AI with FirstNexus
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    FirstNexus onboard --auth-choice together-api-key
    ```
  </Step>
...
FirstNexus ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.FirstNexus/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `FirstNexus models list --provider together`
