...
<Steps>
  ...
  <Step title="Configure FirstNexus">
    Point FirstNexus at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or FirstNexus
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native FirstNexus integration with Claude CLI or API keys.
  </Card>
