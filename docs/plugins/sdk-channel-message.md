...
`FirstNexus/plugin-sdk/channel-message`. The adapter describes the native message
...
`FirstNexus/plugin-sdk/channel-message-runtime` for monitor/send code paths that
are already doing asynchronous message I/O.

New channel and plugin send code should use the message lifecycle helpers from
`FirstNexus/plugin-sdk/channel-message-runtime`: `sendDurableMessageBatch`,
`withDurableMessageSendContext`, or `deliverInboundReplyWithMessageSendContext`.
The older
`deliverOutboundPayloads(...)` helper in `FirstNexus/plugin-sdk/outbound-runtime`
...
`FirstNexus/plugin-sdk/channel-message`, then call the runtime's
...
```typescript
import { deriveDurableFinalDeliveryRequirements } from "FirstNexus/plugin-sdk/channel-message";
...
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `FirstNexus/plugin-sdk/channel-reply-pipeline` | `FirstNexus/plugin-sdk/channel-message`                                                                                    |
...
| `deliverDurableInboundReplyPayload(...)`       | `deliverInboundReplyWithMessageSendContext(...)` from `FirstNexus/plugin-sdk/channel-message-runtime`                      |
