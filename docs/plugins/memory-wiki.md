...
If the active memory plugin exposes shared recall artifacts, FirstNexus can search
...
currently exposing public bridge inputs yet. Run `FirstNexus wiki doctor` first,
...
`FirstNexus wiki status`, `FirstNexus wiki doctor`, and `FirstNexus wiki bridge
...
FirstNexus wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
