---
summary: "Adds the WhatsApp channel surface for sending and receiving FirstNexus messages."
read_when:
...
Adds the WhatsApp channel surface for sending and receiving FirstNexus messages.

## Distribution

- Package: `@FirstNexus/whatsapp`
