...
FirstNexus treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.FirstNexus/settings/voicewake.json`

Shape:

```json
{ "triggers": ["FirstNexus", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
