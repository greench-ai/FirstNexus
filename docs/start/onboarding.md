---
summary: "First-run setup flow for FirstNexus (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give FirstNexus">
...
<Step title="CLI">
  ...
  The app can install the global `FirstNexus` CLI via npm, pnpm, or bun.
