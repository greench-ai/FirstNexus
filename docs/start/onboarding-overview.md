---
summary: "Overview of FirstNexus onboarding options and flows"
read_when:
...
FirstNexus has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `FirstNexus onboard`                   | Launch the app            |
...
CLI command docs: [`FirstNexus onboard`](/cli/onboard)

## macOS app onboarding

Open the FirstNexus app. The first-run wizard walks you through the same steps
