...
read_when:
  - Planning a broad FirstNexus application modernization pass
...
modernization task. If adopting this guidance as a repo-local FirstNexus skill,
create `.agents/skills/FirstNexus-frontend/SKILL.md` first, keep the frontmatter
