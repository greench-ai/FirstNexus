...
FirstNexus also builds a separate idempotent replay view for sessions that
...
FirstNexus auto-enables pruning for Anthropic profiles:
...
If you set explicit values, FirstNexus does not override them.
