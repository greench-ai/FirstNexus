...
import { createSubsystemLogger, redactSensitiveText } from "./FirstNexus-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./FirstNexus-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "FirstNexus:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip FirstNexus-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/FirstNexus/FirstNexus/issues/63921
 */
