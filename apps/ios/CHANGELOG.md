# FirstNexus iOS Changelog

## 2026.5.12 - 2026-05-12

Maintenance update for the current FirstNexus beta release.
...
Maintenance update for the current FirstNexus development release.
...
Maintenance update for the current FirstNexus release.
...
First App Store release of FirstNexus for iPhone. Pair with your FirstNexus Gateway to use chat, voice, sharing, and device actions from iOS.
