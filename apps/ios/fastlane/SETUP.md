...
ASC_KEYCHAIN_SERVICE=nexusclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.nexusclaw.client
# or
...
- The beta flow regenerates `apps/ios/NexusClaw.xcodeproj` from `apps/ios/project.yml` before archiving
