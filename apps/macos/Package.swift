...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../shared/FirstNexusKit"),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                .product(name: "FirstNexusKit", package: "FirstNexusKit"),
            ],
        ...
        .executableTarget(
            ...
            dependencies: [
                ...
                "OpenClawDiscovery",
                .product(name: "FirstNexusKit", package: "FirstNexusKit"),
                .product(name: "FirstNexusChatUI", package: "FirstNexusKit"),
                .product(name: "FirstNexusProtocol", package: "FirstNexusKit"),
