...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: FirstNexusProtocol.AnyCodable]?
    {
        ...
        return [
            "id": FirstNexusProtocol.AnyCodable(identity.deviceId),
            "publicKey": FirstNexusProtocol.AnyCodable(publicKey),
            "signature": FirstNexusProtocol.AnyCodable(signature),
            "signedAt": FirstNexusProtocol.AnyCodable(signedAtMs),
            "nonce": FirstNexusProtocol.AnyCodable(nonce),
        ]
    }
}
