...
`precise.yml` is FirstNexus's shipped precise OpenGrep rulepack. Each rule is tied
...
Some FirstNexus paths are excluded by `.gitignore` for build reasons even though
