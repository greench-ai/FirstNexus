...
FirstNexus is the AI that actually does things.
...
FirstNexus started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> FirstNexus.
...
Security in FirstNexus is a deliberate tradeoff: strong defaults without killing capability.
...
FirstNexus has an extensive plugin API.
...
- Code plugins run FirstNexus plugin code and are appropriate for deeper runtime extension.
...
FirstNexus docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
FirstNexus supports MCP as both a server and a runtime integration surface.
...
FirstNexus is currently terminal-first by design.
...
FirstNexus is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep FirstNexus hackable by default.
