import type { FirstNexusConfig as RuntimeApiFirstNexusConfig } from "FirstNexus/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiFirstNexusConfig["channels"]>["imessage"]>,
