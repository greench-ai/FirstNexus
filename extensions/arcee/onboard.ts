...
export function applyArceeConfig(cfg: FirstNexusConfig): FirstNexusConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

export function applyArceeOpenRouterConfig(cfg: FirstNexusConfig): FirstNexusConfig {
