...
import type { FixedWindowRateLimiter } from "FirstNexus/plugin-sdk/webhook-ingress";
...
vi.mock("FirstNexus/plugin-sdk/webhook-request-guards", () => ({
  readJsonWebhookBodyOrReject,
}));

vi.mock("FirstNexus/plugin-sdk/webhook-targets", () => ({
...
describe("googlechat monitor webhook", () => {
  ...
  afterAll(() => {
    vi.doUnmock("FirstNexus/plugin-sdk/webhook-request-guards");
    vi.doUnmock("FirstNexus/plugin-sdk/webhook-targets");
    vi.doUnmock("./auth.js");
    vi.resetModules();
  });
