...
import { isSecretRef } from "FirstNexus/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: FirstNexusConfig): ResolvedGoogleChatAccount[] {
