...
import type { ProviderPlugin } from "FirstNexus/plugin-sdk/provider-test-contracts";
...
vi.mock("FirstNexus/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("FirstNexus/plugin-sdk/provider-catalog-runtime")
  >("FirstNexus/plugin-sdk/provider-catalog-runtime");
