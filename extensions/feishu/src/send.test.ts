...
vi.mock("FirstNexus/plugin-sdk/markdown-table-runtime", () => ({
  resolveMarkdownTableMode: mockResolveMarkdownTableMode,
}));

vi.mock("FirstNexus/plugin-sdk/text-chunking", async (importOriginal) => {
  const actual = await importOriginal<typeof import("FirstNexus/plugin-sdk/text-chunking")>();
  return {
    ...actual,
...
describe("getMessageFeishu", () => {
  ...
  afterAll(() => {
    vi.doUnmock("FirstNexus/plugin-sdk/markdown-table-runtime");
