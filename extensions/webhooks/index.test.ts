...
function createApi(params?: {
  pluginConfig?: FirstNexusPluginApi["pluginConfig"];
  registerHttpRoute?: FirstNexusPluginApi["registerHttpRoute"];
  logger?: FirstNexusPluginApi["logger"];
}): FirstNexusPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<FirstNexusPluginApi["registerHttpRoute"]>[0];
}
