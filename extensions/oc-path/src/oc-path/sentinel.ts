 ...
 *
 * @module @FirstNexus/oc-path/sentinel
 */

/** Literal marking a redacted secret. Writing it to disk is always a bug. */
export const REDACTED_SENTINEL = "__NEXISCLAW_REDACTED__";
...
// Substring match (not equality) — `prefix__NEXISCLAW_REDACTED__suffix`
