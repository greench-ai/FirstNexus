...
const BROWSER_PROFILE_ARCHIVE_ENV = "NEXISCLAW_MANTIS_BROWSER_PROFILE_TGZ_B64";
const BROWSER_PROFILE_DIR_ENV = "NEXISCLAW_MANTIS_BROWSER_PROFILE_DIR";
...
export async function runMantisDesktopBrowserSmoke(
  ...
  const browserProfileArchiveEnv =
    ...
    trimToValue(env.NEXISCLAW_MANTIS_BROWSER_PROFILE_ARCHIVE_ENV) ??
