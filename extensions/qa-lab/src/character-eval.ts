...
\`\`\``;
  ...
  const prompt = `You are grading FirstNexus natural character conversation transcripts for naturalness, vibes, and funniness.
...
function renderCharacterEvalReport(params: {
  ...
  const lines = [
    "# FirstNexus Character Eval Report",
    "",
