...
import { createWebSearchProviderContractFields } from "FirstNexus/plugin-sdk/provider-web-search-config-contract";
...
export function createBraveWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.FirstNexus.ai/tools/brave-search",
    autoDetectOrder: 10,
