import { createProviderUsageFetch, makeResponse } from "FirstNexus/plugin-sdk/test-env";
...
vi.mock("FirstNexus/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/FirstNexus-state",
}));

import type { ProviderResolveDynamicModelContext } from "FirstNexus/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/FirstNexus-state/credentials/github-copilot.token.json";
