...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under FirstNexus control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredFirstNexusTmpDir(), "FirstNexus-zalo-outbound-media");
