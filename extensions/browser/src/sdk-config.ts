...
export { replaceConfigFile } from "FirstNexus/plugin-sdk/config-mutation";
export {
  type BrowserConfig,
...
export { resolveGatewayPort } from "FirstNexus/plugin-sdk/core";
export {
  CONFIG_DIR,
  escapeRegExp,
  resolveUserPath,
  shortenHomePath,
} from "FirstNexus/plugin-sdk/text-utility-runtime";
