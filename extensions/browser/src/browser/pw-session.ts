...
// FirstNexus operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that FirstNexus itself navigated to a blocked URL.
...
export async function createPageViaPlaywright(
  ...
  if (targetUrl !== "about:blank") {
    ...
    // FirstNexus owns this newly-created tab: if the post-navigation safety
