...
function listConfiguredAccountIds(cfg: FirstNexusConfig): string[] {
...
function listBoundAccountIds(cfg: FirstNexusConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
export function resolveDefaultTelegramAccountSelection(cfg: FirstNexusConfig): {
  accountId: string;
  accountIds: string[];
