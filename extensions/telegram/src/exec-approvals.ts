import { resolveApprovalApprovers } from "FirstNexus/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "FirstNexus/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "FirstNexus/plugin-sdk/approval-runtime";
import type { FirstNexusConfig } from "FirstNexus/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "FirstNexus/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: FirstNexusConfig): Array<string | number> {
