...
import { resolveRequestUrl } from "FirstNexus/plugin-sdk/request-url";
...
// fix for the leak observed in FirstNexus#68128 is the transport lifecycle that
...
function resolveFirstNexusProxyUrlForTelegram(
...
export function resolveTelegramTransport(
  ...
  const managedProxyUrl =
    !effectiveProxyFetch && !hasEnvProxy ? resolveFirstNexusProxyUrlForTelegram() : undefined;
