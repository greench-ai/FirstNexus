...
import { resolveAgentMaxConcurrent } from "FirstNexus/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: FirstNexusConfig): RunOptions<unknown> {
  return {
    sink: {
