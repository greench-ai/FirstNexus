...
import { formatSetExplicitDefaultInstruction } from "FirstNexus/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "FirstNexus/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.NEXISCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: FirstNexusConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: FirstNexusConfig): string {
...
export function listEnabledTelegramAccounts(cfg: FirstNexusConfig): ResolvedTelegramAccount[] {
