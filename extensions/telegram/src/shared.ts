import { resolveNormalizedAccountEntry } from "FirstNexus/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "FirstNexus/plugin-sdk/channel-core";
 ...
 *
 * See: https://github.com/FirstNexus/FirstNexus/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: FirstNexusConfig, accountId: string): boolean {
