...
function resolveFirstNexusVersion(): string {
  try {
 ...
 * and appends the FirstNexus version.
 *
 * Format: "teams.ts[apps]/<sdk-version> FirstNexus/<FirstNexus-version>"
 * Example: "teams.ts[apps]/2.0.5 FirstNexus/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} FirstNexus/${resolveFirstNexusVersion()}`;
  return cachedUserAgent;
}
