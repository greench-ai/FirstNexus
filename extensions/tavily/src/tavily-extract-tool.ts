...
import type { FirstNexusPluginToolContext } from "FirstNexus/plugin-sdk/plugin-entry";
...
export function createTavilyExtractTool(api: FirstNexusPluginApi, ctx?: TavilyToolConfigContext) {
  return {
    name: "tavily_extract",
