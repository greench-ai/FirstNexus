...
vi.mock("FirstNexus/plugin-sdk/provider-web-search", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: FirstNexus", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "FirstNexus" });
  });

  it("runTavilyExtract sends X-Client-Source: FirstNexus", async () => {
