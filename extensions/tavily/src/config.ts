...
export function resolveTavilySearchConfig(cfg?: FirstNexusConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: FirstNexusConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: FirstNexusConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
