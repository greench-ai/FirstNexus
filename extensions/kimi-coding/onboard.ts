...
export function applyKimiCodeProviderConfig(cfg: FirstNexusConfig): FirstNexusConfig {
  return kimiCodingPresetAppliers.applyProviderConfig(cfg);
}

export function applyKimiCodeConfig(cfg: FirstNexusConfig): FirstNexusConfig {
