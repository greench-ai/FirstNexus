...
export function buildComfyConfig(config: Record<string, unknown>): FirstNexusConfig {
  return {
    plugins: {
      entries: {
        comfy: { config },
...
export function buildLegacyComfyConfig(config: Record<string, unknown>): FirstNexusConfig {
  return {
    models: {
      providers: {
        comfy: config,
