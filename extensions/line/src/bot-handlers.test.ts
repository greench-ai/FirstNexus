...
vi.mock("FirstNexus/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("FirstNexus/plugin-sdk/channel-pairing", () => ({
...
vi.mock("FirstNexus/plugin-sdk/command-auth", () => ({
...
vi.mock("FirstNexus/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("FirstNexus/plugin-sdk/reply-history", () => ({
...
vi.mock("FirstNexus/plugin-sdk/routing", () => ({
...
vi.mock("FirstNexus/plugin-sdk/conversation-runtime", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("FirstNexus/plugin-sdk/channel-inbound");
    vi.doUnmock("FirstNexus/plugin-sdk/channel-pairing");
    vi.doUnmock("FirstNexus/plugin-sdk/command-auth");
    vi.doUnmock("FirstNexus/plugin-sdk/runtime-group-policy");
    vi.doUnmock("FirstNexus/plugin-sdk/runtime-env");
    vi.doUnmock("FirstNexus/plugin-sdk/reply-history");
    vi.doUnmock("FirstNexus/plugin-sdk/routing");
