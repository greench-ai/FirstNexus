...
vi.mock("FirstNexus/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("FirstNexus/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("FirstNexus/plugin-sdk/channel-activity-runtime");
