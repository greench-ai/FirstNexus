import type { ChannelSetupAdapter, FirstNexusConfig } from "FirstNexus/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "FirstNexus/plugin-sdk/setup";
...
export function isLineConfigured(cfg: FirstNexusConfig, accountId: string): boolean {
