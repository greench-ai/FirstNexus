...
// steer FirstNexus-managed Claude CLI runs toward a different provider,
...
function isFirstNexusRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isFirstNexusRequestedYolo(context)
