...
// without touching ~/.FirstNexus/FirstNexus.json.
...
vi.mock("FirstNexus/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("FirstNexus/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("FirstNexus/plugin-sdk/config-mutation");
  vi.resetModules();
});
