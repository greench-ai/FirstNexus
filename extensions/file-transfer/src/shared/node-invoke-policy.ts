...
type PreflightResult =
  ...
  | {
      ok: false;
      result: FirstNexusPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: FirstNexusPluginNodeInvokePolicyContext,
): Promise<FirstNexusPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): FirstNexusPluginNodeInvokePolicy {
  return {
    commands: COMMANDS,
