...
// a config block to ~/.FirstNexus/FirstNexus.json under
...
import { mutateConfigFile } from "FirstNexus/plugin-sdk/config-mutation";
...
export async function persistAllowAlways(input: {
  ...
  await mutateConfigFile({
    ...
    mutate: (draft) => {
      // Plugin config is intentionally plugin-owned; the root FirstNexusConfig
