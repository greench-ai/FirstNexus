...
import { fetchWithTimeout } from "FirstNexus/plugin-sdk/provider-http";
...
export const DEEPINFRA_MODELS_URL = `${DEEPINFRA_BASE_URL}/models?sort_by=FirstNexus&filter=with_meta`;
