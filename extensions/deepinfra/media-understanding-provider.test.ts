...
vi.mock("FirstNexus/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("FirstNexus/plugin-sdk/media-understanding")>(
    "FirstNexus/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("FirstNexus/plugin-sdk/media-understanding");
  vi.resetModules();
});
