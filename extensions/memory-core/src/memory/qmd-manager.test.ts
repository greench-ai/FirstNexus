...
const MEMORY_EMBEDDING_PROVIDERS_KEY = Symbol.for("FirstNexus.memoryEmbeddingProviders");
...
vi.mock("FirstNexus/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("FirstNexus/plugin-sdk/file-lock")>(
    "FirstNexus/plugin-sdk/file-lock",
  );
  return {
    ...actual,
