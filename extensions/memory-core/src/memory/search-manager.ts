...
import { checkQmdBinaryAvailability } from "FirstNexus/plugin-sdk/memory-core-host-engine-qmd";
import {
...
const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("FirstNexus.memorySearchManagerCache");
type Maybe<T> = T | null;
