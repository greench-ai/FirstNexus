...
import { createAsyncLock } from "FirstNexus/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "FirstNexus/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "FirstNexus/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "FirstNexus/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- FirstNexus:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- FirstNexus:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "FirstNexus:dreaming:backfill-entry";
