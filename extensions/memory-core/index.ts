...
import { resolveMemoryBackendConfig } from "FirstNexus/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  ...
  getConfig?: () => FirstNexusConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): FirstNexusConfig | undefined {
...
function resolveMemoryToolOptions(ctx: FirstNexusPluginToolContext): MemoryToolOptions {
