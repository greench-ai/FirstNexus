...
import { buildApiKeyCredential } from "FirstNexus/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: FirstNexusPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: FirstNexusConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "FirstNexus configure". ' +
        "See: https://docs.FirstNexus.ai/providers/ollama",
    });
  },
});
