import { callGatewayTool } from "FirstNexus/plugin-sdk/agent-harness-runtime";
import type {
  AnyAgentTool,
  FirstNexusPluginApi,
...
export function createRemindTool(
  toolContext: FirstNexusPluginToolContext = {},
...
export function registerRemindTool(api: FirstNexusPluginApi): void {
