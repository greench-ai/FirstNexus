...
import type {
  ...
  MessageEventContent,
} from "@FirstNexus/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@FirstNexus/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } =
    await import("FirstNexus/plugin-sdk/qa-runner-runtime");
