...
import { resolveConfiguredCapabilityProvider } from "FirstNexus/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "FirstNexus/plugin-sdk/realtime-voice";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: FirstNexusConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as FirstNexusConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as FirstNexusConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as FirstNexusConfig | null) ?? undefined,
