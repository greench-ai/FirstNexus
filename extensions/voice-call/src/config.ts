import { REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES } from "FirstNexus/plugin-sdk/realtime-voice";
import {
...
const VoiceCallRealtimeConfigSchema = z
  .object({
    ...
    /** Tool policy for the shared FirstNexus agent consult tool. */
    toolPolicy: VoiceCallRealtimeToolPolicySchema.default("safe-read-only"),
    /** Guidance for when the realtime model should call the FirstNexus agent consult tool. */
