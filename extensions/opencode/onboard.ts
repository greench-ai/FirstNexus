...
export function applyOpencodeZenProviderConfig(cfg: FirstNexusConfig): FirstNexusConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: FirstNexusConfig): FirstNexusConfig {
