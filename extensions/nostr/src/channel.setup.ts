...
import { patchTopLevelChannelConfigSection } from "FirstNexus/plugin-sdk/setup";
import {
...
function getNostrConfig(cfg: FirstNexusConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: FirstNexusConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: FirstNexusConfig): string {
