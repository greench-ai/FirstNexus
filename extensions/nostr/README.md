...
Nostr DM channel plugin for FirstNexus using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to FirstNexus. It enables your bot to:
...
# Configure FirstNexus to use local relay
