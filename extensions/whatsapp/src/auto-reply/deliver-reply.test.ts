...
vi.mock("FirstNexus/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("FirstNexus/plugin-sdk/text-utility-runtime")>(
    "FirstNexus/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
