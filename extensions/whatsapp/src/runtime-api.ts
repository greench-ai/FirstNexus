export { getChatChannelMeta, type ChannelPlugin } from "FirstNexus/plugin-sdk/core";
...
export { normalizeE164 } from "FirstNexus/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "FirstNexus/plugin-sdk/config-contracts";
import type { FirstNexusConfig as RuntimeFirstNexusConfig } from "FirstNexus/plugin-sdk/config-contracts";

export { type ChannelMessageActionName } from "FirstNexus/plugin-sdk/channel-contract";
...
export type FirstNexusConfig = RuntimeFirstNexusConfig;
