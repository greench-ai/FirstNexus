...
import { clamp } from "FirstNexus/plugin-sdk/text-utility-runtime";
...
export function resolveHeartbeatSeconds(cfg: FirstNexusConfig, overrideSeconds?: number): number {
