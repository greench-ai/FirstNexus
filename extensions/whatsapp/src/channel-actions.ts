...
function areWhatsAppAgentReactionsEnabled(params: { cfg: FirstNexusConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: FirstNexusConfig) {
