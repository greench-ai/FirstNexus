...
import { formatInboundEnvelope } from "FirstNexus/plugin-sdk/channel-envelope";
...
function makeCfg(storePath: string): FirstNexusConfig {
  return {
...
function createHandlerForTest(opts: { cfg: FirstNexusConfig; replyResolver: unknown }) {
