...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "FirstNexus/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: FirstNexusConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FirstNexusConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FirstNexusConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FirstNexusConfig): ResolvedWhatsAppAccount[] {
