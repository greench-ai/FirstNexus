...
export function resolveSearxngCategories(config?: FirstNexusConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: FirstNexusConfig): string | undefined {
