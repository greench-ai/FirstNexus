...
function resolveKimiBaseUrl(kimi?: KimiConfig, openClawConfig?: FirstNexusConfig): string {
...
export async function executeKimiWebSearchProviderTool(
  ctx: { config?: FirstNexusConfig; searchConfig?: SearchConfigRecord },
  ...
  if (!result.grounded) {
    return {
      ...
      provider: "kimi",
      model,
      docs: "https://docs.FirstNexus.ai/tools/kimi-search",
