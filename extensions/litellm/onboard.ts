...
export function applyLitellmProviderConfig(cfg: FirstNexusConfig): FirstNexusConfig {
  return litellmPresetAppliers.applyProviderConfig(cfg);
}

export function applyLitellmConfig(cfg: FirstNexusConfig): FirstNexusConfig {
