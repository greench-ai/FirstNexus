import type { WebFetchProviderPlugin } from "FirstNexus/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "FirstNexus/plugin-sdk/provider-web-fetch";
