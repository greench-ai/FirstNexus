...
const installedSymbol = Symbol.for("FirstNexus.lobster.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("FirstNexus.lobster.ajv-compile-cache.entries");
