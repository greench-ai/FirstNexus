...
import { resolveDangerousNameMatchingEnabled } from "FirstNexus/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full FirstNexus config object. */
function getChannelConfig(cfg: FirstNexusConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: FirstNexusConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.NEXISCLAW_BOT_NAME ?? "FirstNexus";
