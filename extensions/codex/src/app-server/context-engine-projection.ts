import type { AgentMessage } from "FirstNexus/plugin-sdk/agent-harness-runtime";
...
const CONTEXT_HEADER = "FirstNexus assembled context for this turn:";
...
/**
 * Project assembled FirstNexus context-engine messages into Codex prompt inputs.
 */
