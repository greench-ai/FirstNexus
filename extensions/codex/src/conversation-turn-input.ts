...
import type { PluginHookInboundClaimEvent } from "FirstNexus/plugin-sdk/plugin-entry";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // FirstNexus channels expose either local staged files or remote URLs. Keep
