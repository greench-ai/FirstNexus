import { createClaimableDedupe } from "FirstNexus/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: FirstNexusConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<FirstNexusConfig["channels"]>["mattermost"]>;
