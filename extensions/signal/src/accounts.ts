...
function mergeSignalAccountConfig(cfg: FirstNexusConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: FirstNexusConfig): ResolvedSignalAccount[] {
