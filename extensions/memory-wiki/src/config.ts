...
import { mapPluginConfigIssues } from "FirstNexus/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type FirstNexusPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: FirstNexusPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".FirstNexus", "wiki", "main");
}
