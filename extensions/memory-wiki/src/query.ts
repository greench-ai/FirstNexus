...
import { getActiveMemorySearchManager } from "FirstNexus/plugin-sdk/memory-host-search";
import {
  extractTranscriptStemFromSessionsMemoryHit,
  loadCombinedSessionStoreForGateway,
  resolveTranscriptStemToSessionKeys,
} from "FirstNexus/plugin-sdk/session-transcript-hit";
import {
  createAgentToAgentPolicy,
  createSessionVisibilityGuard,
  resolveEffectiveSessionToolsVisibility,
} from "FirstNexus/plugin-sdk/session-visibility";
...
const RELATED_BLOCK_PATTERN =
  /<!-- FirstNexus:wiki:related:start -->[\s\S]*?<!-- FirstNexus:wiki:related:end -->/g;
