...
import { buildApprovalInteractiveReplyFromActionDescriptors } from "FirstNexus/plugin-sdk/approval-reply-runtime";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<FirstNexusConfig["channels"]>["slack"]>["execApprovals"]
>;
