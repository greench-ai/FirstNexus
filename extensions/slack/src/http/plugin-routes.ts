...
import type { FirstNexusPluginApi } from "FirstNexus/plugin-sdk/channel-plugin-common";
...
export function registerSlackPluginHttpRoutes(api: FirstNexusPluginApi): void {
