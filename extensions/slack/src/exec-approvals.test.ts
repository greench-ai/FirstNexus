...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<FirstNexusConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<FirstNexusConfig["channels"]>["slack"]>>,
): FirstNexusConfig {
  return {
    channels: {
      slack: {
