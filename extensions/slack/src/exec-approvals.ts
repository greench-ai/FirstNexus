...
import { normalizeStringifiedOptionalString } from "FirstNexus/plugin-sdk/string-coerce-runtime";
...
function resolveSlackOwnerApprovers(cfg: FirstNexusConfig): string[] {
