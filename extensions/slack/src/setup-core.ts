...
function enableSlackAccount(cfg: FirstNexusConfig, accountId: string): FirstNexusConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: FirstNexusConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: FirstNexusConfig; accountId: string }) =>
