...
import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "FirstNexus/plugin-sdk/markdown-table-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "FirstNexus/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("FirstNexus/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("FirstNexus/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("FirstNexus/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("FirstNexus/plugin-sdk/conversation-runtime").resolveConversationLabel;
type RecordInboundSessionMetaSafe =
  typeof import("FirstNexus/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
type ResolveMarkdownTableMode =
  typeof import("FirstNexus/plugin-sdk/markdown-table-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("FirstNexus/plugin-sdk/routing").resolveAgentRoute;
