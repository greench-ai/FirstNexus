...
vi.mock("FirstNexus/plugin-sdk/system-event-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("FirstNexus/plugin-sdk/system-event-runtime")>();
  return {
    ...actual,
...
vi.mock("FirstNexus/plugin-sdk/heartbeat-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("FirstNexus/plugin-sdk/heartbeat-runtime")>();
  return {
    ...actual,
...
describe("registerSlackInteractionEvents", () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "FirstNexus:verify" }],
            },
          ],
        },
      },
  ...
  it("registers a matcher that accepts plugin action ids beyond the FirstNexus prefix", () => {
    const { ctx, getActionMatcher } = createContext();
    registerSlackInteractionEvents({ ctx: ctx as never });

    const matcher = getActionMatcher();
    expect(matcher.test("FirstNexus:verify")).toBe(true);
  ...
  it("treats Slack reply buttons as plain interaction events instead of plugin dispatch", async () => {
    ...
    await handler({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "FirstNexus:reply_button" }],
            },
          ],
        },
      },
      action: {
        type: "button",
        action_id: "FirstNexus:reply_button",
        block_id: "reply_actions",
        value: "codex",
    ...
    const eventText = mockCallArg(enqueueSystemEventMock, 0, "enqueueSystemEvent");
    expect(eventText).toContain('"actionId":"FirstNexus:reply_button"');
    expectRecordFields(
      requireRecord(
      ...
      {
        contextKey: "slack:interaction:C1:100.200:FirstNexus:reply_button",
        deliveryContext: {
          accountId: "default",
          channel: "slack",
          threadId: "100.100",
  ...
  it("drops modal lifecycle payloads when mismatch guard triggers", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "FirstNexus:deploy_form",
  ...
  it("falls back to container channel and message timestamps", async () => {
    ...
    await handler({
      ...
      action: {
        type: "button",
        action_id: "FirstNexus:container",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "FirstNexus:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "FirstNexus:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "FirstNexus:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "FirstNexus:datetime" }],
            },
          ],
        },
      },
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expectRecordFields(payload as unknown as Record<string, unknown>, {
      ...
      actionId: "view:FirstNexus:deploy_form",
      callbackId: "FirstNexus:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("keeps no-channel modal events open when allowFrom is unset", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V444",
          callback_id: "FirstNexus:routing_form",
  ...
  it("captures modal input labels and picker values across block types", async () => {
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@FirstNexus.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.FirstNexus.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expectRecordFields(inputByActionId(inputs, "email_input"), {
      inputKind: "email",
      inputEmail: "team@FirstNexus.ai",
    });
    expectRecordFields(inputByActionId(inputs, "url_input"), {
      inputKind: "url",
      inputUrl: "https://docs.FirstNexus.ai/",
    });
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "FirstNexus:long_richtext",
  ...
  it("caps oversized interaction payloads with compact summaries", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V915",
          callback_id: "FirstNexus:oversize",
          private_metadata: JSON.stringify({
            channelId: "D915",
            channelType: "im",
            userId: "U915",
