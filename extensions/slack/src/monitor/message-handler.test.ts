...
vi.mock("FirstNexus/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("FirstNexus/plugin-sdk/channel-inbound")>(
    "FirstNexus/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
