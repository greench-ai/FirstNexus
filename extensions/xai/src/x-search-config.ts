...
function resolveLegacyXSearchConfig(config?: FirstNexusConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: FirstNexusConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: FirstNexusConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: FirstNexusConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: FirstNexusConfig): JsonRecord | undefined {
