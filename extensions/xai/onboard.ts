...
>({
  ...
  resolveParams: (_cfg: FirstNexusConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: FirstNexusConfig): FirstNexusConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: FirstNexusConfig): FirstNexusConfig {
