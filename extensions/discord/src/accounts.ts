...
import type { DiscordAccountConfig, DiscordActionConfig, FirstNexusConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: FirstNexusConfig): ResolvedDiscordAccount[] {
