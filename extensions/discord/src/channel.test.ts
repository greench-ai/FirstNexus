...
function createCfg(): FirstNexusConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: FirstNexusConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: FirstNexusConfig, accountId = "default") {
