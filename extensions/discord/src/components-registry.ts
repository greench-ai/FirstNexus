...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("FirstNexus.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("FirstNexus.discord.modalEntries");
