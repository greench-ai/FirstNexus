import { createSubsystemLogger, formatDurationSeconds } from "FirstNexus/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("FirstNexus/plugin-sdk/runtime-env").createSubsystemLogger
>;
