...
let conversationRuntimePromise:
  | Promise<typeof import("FirstNexus/plugin-sdk/conversation-binding-runtime")>
  | undefined;

async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("FirstNexus/plugin-sdk/conversation-binding-runtime");
