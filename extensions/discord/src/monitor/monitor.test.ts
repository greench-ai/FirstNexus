...
import { buildPluginBindingApprovalCustomId } from "FirstNexus/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  const createCfg = (): FirstNexusConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/FirstNexus-sessions-test.json");
