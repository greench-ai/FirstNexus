...
import { buildPairingReply } from "FirstNexus/plugin-sdk/conversation-runtime";
...
function resolveDiscordCommandOwnerAllowFrom(cfg: FirstNexusConfig): string[] | undefined {
