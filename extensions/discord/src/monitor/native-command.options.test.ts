...
let listNativeCommandSpecs: typeof import("FirstNexus/plugin-sdk/command-auth").listNativeCommandSpecs;
...
function createNativeCommand(
  ...
  opts?: {
    ...
    discordConfig?: NonNullable<FirstNexusConfig["channels"]>["discord"];
  },
  ...
  const baseCfg: FirstNexusConfig = opts?.cfg ?? {};
  const discordConfig: NonNullable<FirstNexusConfig["channels"]>["discord"] =
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("FirstNexus/plugin-sdk/command-auth"));
  ...
  it("returns no autocomplete choices for group DMs outside dm.groupChannels", async () => {
    ...
    } satisfies NonNullable<FirstNexusConfig["channels"]>["discord"];
    const command = createNativeCommand("think", {
      cfg: {
        commands: {
          allowFrom: {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<FirstNexusConfig["channels"]>["discord"];
