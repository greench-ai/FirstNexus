import type { ChatCommandDefinition, CommandArgs } from "FirstNexus/plugin-sdk/command-auth-native";
...
import { resolveStorePath, updateSessionStore } from "FirstNexus/plugin-sdk/session-store-runtime";
