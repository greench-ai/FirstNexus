...
import * as commandRegistryModule from "FirstNexus/plugin-sdk/command-auth";
import type { ChatCommandDefinition, CommandArgsParsing } from "FirstNexus/plugin-sdk/command-auth";
import type { ModelsProviderData } from "FirstNexus/plugin-sdk/command-auth";
import type { FirstNexusConfig } from "FirstNexus/plugin-sdk/config-contracts";
import * as globalsModule from "FirstNexus/plugin-sdk/runtime-env";
import {
  loadSessionStore,
  resolveStorePath,
  saveSessionStore,
} from "FirstNexus/plugin-sdk/session-store-runtime";
import * as commandTextModule from "FirstNexus/plugin-sdk/text-utility-runtime";
...
describe("Discord model picker interactions", () => {
  beforeEach(async () => {
    tempDir = await mkdtemp(path.join(os.tmpdir(), "FirstNexus-discord-model-picker-"));
    vi.useRealTimers();
    vi.restoreAllMocks();
  });
