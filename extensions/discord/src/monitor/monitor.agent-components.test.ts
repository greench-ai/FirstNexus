...
import { peekSystemEvents, resetSystemEventsForTest } from "FirstNexus/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): FirstNexusConfig => ({}) as FirstNexusConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`FirstNexus pairing approve discord ${code}`);
