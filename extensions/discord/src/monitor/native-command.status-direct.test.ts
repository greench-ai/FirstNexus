...
vi.mock("FirstNexus/plugin-sdk/reply-dispatch-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("FirstNexus/plugin-sdk/reply-dispatch-runtime")
...
vi.mock("FirstNexus/plugin-sdk/command-status-runtime", () => ({
...
function createConfig(params?: { requireMention?: boolean }): FirstNexusConfig {
  return {
    commands: {
...
describe("discord native /status", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("FirstNexus/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithDispatcher,
    );
    discordNativeCommandTesting.setMatchPluginCommand(
      (() => null) as typeof import("FirstNexus/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
  ...
  it("prioritizes direct status replies over matching plugin commands", async () => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand((() => ({
      ...
      args: undefined,
    })) as typeof import("FirstNexus/plugin-sdk/plugin-runtime").matchPluginCommand);
    discordNativeCommandTesting.setExecutePluginCommand(
      executePluginCommand as typeof import("FirstNexus/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    const cfg = createConfig();
    const command = await createStatusCommand(cfg);
    const interaction = createInteraction();
