  ...
  it("renames created thread when generated mode is enabled", async () => {
    ...
    const result = await maybeCreateDiscordAutoThread(
      createBaseParams({
        ...
        channelName: "FirstNexus",
        channelDescription: "FirstNexus development coordination and release planning",
    ...
    expectGeneratedTitleField("channelName", "FirstNexus");
    expectGeneratedTitleField(
      "channelDescription",
      "FirstNexus development coordination and release planning",
    );
