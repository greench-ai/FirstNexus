...
import { collectProviderDangerousNameMatchingScopes } from "FirstNexus/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: FirstNexusConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: FirstNexusConfig,
  doctorFixCommand: string,
): { config: FirstNexusConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: FirstNexusConfig): string[] {
