...
// Deprecated compatibility surface for existing @FirstNexus/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "FirstNexus/plugin-sdk/runtime-group-policy";
