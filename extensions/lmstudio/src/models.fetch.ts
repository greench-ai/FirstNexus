...
import { SELF_HOSTED_DEFAULT_COST } from "FirstNexus/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "FirstNexus/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to FirstNexus model definitions. */
