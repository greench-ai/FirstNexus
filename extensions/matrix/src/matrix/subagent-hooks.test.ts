import type { FirstNexusPluginApi as MatrixEntryPluginApi } from "FirstNexus/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("FirstNexus/plugin-sdk/conversation-binding-runtime", () => ({
