import type { OutputRuntimeEnv } from "FirstNexus/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "FirstNexus/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "FirstNexus Gateway",
    },
    confirm: {
