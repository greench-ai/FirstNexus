...
export type MatrixStreamingConfig = {
  ...
  progress?: import("FirstNexus/plugin-sdk/channel-streaming").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<FirstNexusConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: FirstNexusConfig["secrets"];
  [key: string]: unknown;
};
