...
export type PromptDefaultModelResult = { model?: string; config?: FirstNexusConfig };
...
function resolveConfiguredModelRaw(cfg: FirstNexusConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: FirstNexusConfig): string[] {
