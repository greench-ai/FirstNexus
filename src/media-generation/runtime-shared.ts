...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: FirstNexusConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: FirstNexusConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: FirstNexusConfig;
  agentDir?: string;
  listProviders: (cfg?: FirstNexusConfig) => CapabilityProviderCandidate[];
}): string[] {
