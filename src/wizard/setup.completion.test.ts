...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("nexusclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "nexusclaw");
