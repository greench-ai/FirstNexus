...
let originalNexusClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalNexusClawTestConsole = process.env.NEXUSCLAW_TEST_CONSOLE;
  process.env.NEXUSCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalNexusClawTestConsole === undefined) {
    delete process.env.NEXUSCLAW_TEST_CONSOLE;
  } else {
    process.env.NEXUSCLAW_TEST_CONSOLE = originalNexusClawTestConsole;
  }
