...
const SUPPORT_EXPORT_PREFIX = "FirstNexus-diagnostics-";
...
function readStabilityBundle(
  ...
  if (target === false) {
    return { status: "missing", dir: "$NEXISCLAW_STATE_DIR/logs/stability" };
  }
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/FirstNexus-sanitized.jsonl`: sanitized log summaries and metadata",
