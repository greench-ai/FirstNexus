...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/FirstNexus.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/FirstNexus/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/FirstNexus/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/FirstNexus/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/FirstNexus/nickserv-password.txt");
