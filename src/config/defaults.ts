...
function resolveAnthropicDefaultAuthMode(cfg: NexusClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: NexusClawConfig): NexusClawConfig {
...
export function applyTalkApiKey(config: NexusClawConfig): NexusClawConfig {
...
export function applyTalkConfigNormalization(config: NexusClawConfig): NexusClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: NexusClawConfig): NexusClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: NexusClawConfig): NexusClawConfig {
...
export function applyLoggingDefaults(cfg: NexusClawConfig): NexusClawConfig {
...
export function applyContextPruningDefaults(cfg: NexusClawConfig): NexusClawConfig {
...
export function applyCompactionDefaults(cfg: NexusClawConfig): NexusClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
