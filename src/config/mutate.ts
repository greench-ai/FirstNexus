...
type ConfigMutationIO = {
  ...
  writeConfigFile: (cfg: FirstNexusConfig, options?: ConfigWriteOptions) => Promise<unknown>;
};
...
export async function mutateConfigFile<T = void>(params: {
  ...
  const draft = structuredClone(baseConfig) as FirstNexusConfig;
