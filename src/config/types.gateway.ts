...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "FirstNexus.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/FirstNexus"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__FirstNexus__/canvas or /__FirstNexus__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
   ...
   * startup. Lets operators manage Funnel exposure outside FirstNexus without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/FirstNexus/FirstNexus/issues/65485
   */
