      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/FirstNexus.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/FirstNexus.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/FirstNexus.plugin.json",
...
describe("web search provider config", () => {
  ...
  it("rejects installable provider ids when the plugin is not active", () => {
    ...
    expect(issue.message).toBe(
      'web_search provider is not available: brave (install or enable plugin "brave", then run FirstNexus doctor --fix)',
    );
