...
export type DiscordVoiceRealtimeConfig = {
  ...
  /** Whether bidi should force the FirstNexus agent brain for every substantive turn. */
  ...
  /** Debounce window before buffered transcripts are sent to the FirstNexus agent. */
  debounceMs?: number;
...
export type DiscordVoiceAgentSessionConfig = {
  /** Which FirstNexus conversation should receive voice turns. Default: "voice". */
  mode?: "voice" | "target";
...
export type DiscordVoiceConfig = {
  ...
  /** Route voice turns through an existing FirstNexus Discord conversation. */
