...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "FirstNexus-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "FirstNexus-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "FirstNexus-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "FirstNexus-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "FirstNexus-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "FirstNexus-messaging-read-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "FirstNexus-legacy-state");
    const configDir = path.join("/tmp", "FirstNexus-current-config");
