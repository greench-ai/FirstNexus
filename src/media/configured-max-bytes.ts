...
export function resolveConfiguredMediaMaxBytes(cfg?: FirstNexusConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: FirstNexusConfig | undefined, kind: MediaKind) {
