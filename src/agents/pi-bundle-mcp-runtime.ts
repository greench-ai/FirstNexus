...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("FirstNexus.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: FirstNexusConfig): number {
