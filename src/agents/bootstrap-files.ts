...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "FirstNexus:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: FirstNexusConfig): AgentContextInjection {
