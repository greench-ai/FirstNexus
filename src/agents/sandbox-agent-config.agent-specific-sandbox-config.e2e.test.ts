...
async function resolveContext(config: NexusClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): NexusClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
