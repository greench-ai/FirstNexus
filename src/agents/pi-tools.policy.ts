...
export function resolveSubagentToolPolicy(cfg?: NexusClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: NexusClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: NexusClawConfig["tools"];
