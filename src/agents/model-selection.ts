...
export function isCliProvider(provider: string, cfg?: NexusClawConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: NexusClawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: NexusClawConfig }): ModelCatalogEntry[] {
