...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("nexusclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("nexusclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("nexusclaw-cache-test2-");
