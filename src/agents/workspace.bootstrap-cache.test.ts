...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    ...
    workspaceDir = await makeTempWorkspace("FirstNexus-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("FirstNexus-cache-test1-");
    const workspace2 = await makeTempWorkspace("FirstNexus-cache-test2-");
