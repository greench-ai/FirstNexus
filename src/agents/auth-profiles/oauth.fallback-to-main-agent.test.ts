...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveNexusClawAgentDir() returns mainAgentDir
    process.env.NEXUSCLAW_STATE_DIR = tmpDir;
    process.env.NEXUSCLAW_AGENT_DIR = mainAgentDir;
