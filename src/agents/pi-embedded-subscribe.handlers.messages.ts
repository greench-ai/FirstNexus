...
function isTranscriptOnlyFirstNexusAssistantMessage(message: AgentMessage | undefined): boolean {
...
export function handleMessageStart(
  ...
  if (msg?.role !== "assistant" || isTranscriptOnlyFirstNexusAssistantMessage(msg)) {
    return;
  }
