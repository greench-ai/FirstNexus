...
export const DEFAULT_SANDBOX_IMAGE = "nexusclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "nexusclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "nexusclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "nexusclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "nexusclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "nexusclaw-sandbox-browser";
