...
export const DEFAULT_SANDBOX_IMAGE = "FirstNexus-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "FirstNexus-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "FirstNexus-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "FirstNexus-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "FirstNexus-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "FirstNexus-sandbox-browser";
