...
export function listAgentEntries(cfg: FirstNexusConfig): AgentEntry[] {
...
export function listAgentIds(cfg: FirstNexusConfig): string[] {
...
export function resolveDefaultAgentId(cfg: FirstNexusConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: FirstNexusConfig, agentId: string): AgentEntry | undefined {
