...
const ensureNexusClawModelsJsonMock = vi.fn();
...
vi.mock("./models-config.js", () => ({
  ensureNexusClawModelsJson: (...args: unknown[]) => ensureNexusClawModelsJsonMock(...args),
}));
...
describe("runBtwSideQuestion", () => {
  beforeEach(() => {
    ...
    ensureNexusClawModelsJsonMock.mockReset();
