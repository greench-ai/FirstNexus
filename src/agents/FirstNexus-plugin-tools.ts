...
import {
  resolveFirstNexusPluginToolInputs,
  type FirstNexusPluginToolOptions,
} from "./FirstNexus-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveFirstNexusPluginToolsOptions = FirstNexusPluginToolOptions & {
...
export function resolveFirstNexusPluginToolsForOptions(params: {
  options?: ResolveFirstNexusPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveFirstNexusPluginToolInputs({
