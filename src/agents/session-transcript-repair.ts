...
function makeMissingToolResult(params: {
  ...
  // explicit FirstNexus diagnostic text unless the caller opts in.
  text?: string;
    ...
    content: [
      {
        ...
        text:
          params.text ??
          "[FirstNexus] missing tool result in session history; inserted synthetic error result for transcript repair.",
      },
    ],
    isError: true,
    timestamp: Date.now(),
