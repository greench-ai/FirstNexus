...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.FirstNexus/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "FirstNexus doctor" and "FirstNexus approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
