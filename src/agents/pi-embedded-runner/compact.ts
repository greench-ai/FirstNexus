...
function resolvePostCompactionIndexSyncMode(config?: NexusClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureNexusClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createNexusClawCodingTools({
      exec: {
