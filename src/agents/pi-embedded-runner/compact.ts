...
import { createFirstNexusCodingTools, resolveProcessToolScopeKey } from "../pi-tools.js";
...
async function compactEmbeddedPiSessionDirectOnce(
  ...
  try {
    ...
    const toolsRaw = createFirstNexusCodingTools({
      exec: {
    ...
    const filteredBundledTools = applyFinalEffectiveToolPolicy({
      ...
      // createFirstNexusCodingTools(...) also omit it, so both paths resolve
    ...
    try {
      ...
      // exact FirstNexus-managed registrations so custom tools survive startup.
