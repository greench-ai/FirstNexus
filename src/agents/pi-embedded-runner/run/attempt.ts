...
import { resolveNexusClawDocsPath } from "../../docs-path.js";
...
import { createNexusClawCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "nexusclaw.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "nexusclaw.sessions_yield";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveNexusClawAgentDir();
    ...
    const docsPath = await resolveNexusClawDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/nexusclaw/nexusclaw/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("nexusclaw:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/nexusclaw/nexusclaw/issues/8643
