...
describe("isSilentOverflowProneModel", () => {
  ...
  // FirstNexus#75799 reporter's setup: an OpenAI-compatible in-house gateway
  ...
  // FirstNexus's preemptive compaction continues to handle real overflow.
...
describe("applyPiAutoCompactionGuard", () => {
  // Direct repro of FirstNexus#75799: pi-ai's silent-overflow detection misfires
  ...
  // state.messages intact; FirstNexus's preemptive compaction continues to
