...
function resolveAnthropicOpusThinking(cfg: NexusClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<NexusClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<NexusClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<NexusClawConfig> = {
        agents: {
          defaults: {
            models: {
