...
function redactTranscriptText(value: string, cfg?: FirstNexusConfig): string {
...
function redactTranscriptContentBlock(block: unknown, cfg?: FirstNexusConfig): unknown {
...
function redactTranscriptContent(content: unknown, cfg?: FirstNexusConfig): unknown {
...
function redactTranscriptMessage(message: AgentMessage, cfg?: FirstNexusConfig): AgentMessage {
