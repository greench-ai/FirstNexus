...
function requireExecTool(tools: ReturnType<typeof createFirstNexusCodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createFirstNexusCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createFirstNexusCodingTools({
      config: cfg,
