...
import type { FirstNexusSkillMetadata, SkillEntry } from "./skills/types.js";
...
const fixtureSuite = createFixtureSuite("FirstNexus-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: FirstNexusSkillMetadata;
}): SkillEntry {
