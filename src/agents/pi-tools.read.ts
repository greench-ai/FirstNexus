...
function resolveAdaptiveReadMaxBytes(options?: NexusClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createNexusClawReadTool(base, {
...
export function createNexusClawReadTool(
  base: AnyAgentTool,
  options?: NexusClawReadToolOptions,
): AnyAgentTool {
