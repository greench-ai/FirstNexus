...
const NEXUSCLAW_ATTRIBUTION_PRODUCT = "NexusClaw";
const NEXUSCLAW_ATTRIBUTION_ORIGINATOR = "nexusclaw";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: NEXUSCLAW_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: NEXUSCLAW_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${NEXUSCLAW_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
