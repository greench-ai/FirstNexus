...
describe("loadMergedBundleMcpConfig", () => {
  it("lets FirstNexus mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps FirstNexus transports to downstream CLI types when requested", () => {
    expect(
