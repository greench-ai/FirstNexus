...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "FirstNexus-sbx-test",
    runtimeLabel: params.containerName ?? "FirstNexus-sbx-test",
    containerName: params.containerName ?? "FirstNexus-sbx-test",
