...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "nexusclaw-sbx-test",
    runtimeLabel: params.containerName ?? "nexusclaw-sbx-test",
    containerName: params.containerName ?? "nexusclaw-sbx-test",
