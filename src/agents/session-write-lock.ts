...
const CLEANUP_STATE_KEY = Symbol.for("nexusclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("nexusclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("nexusclaw.sessionWriteLockWatchdogState");
