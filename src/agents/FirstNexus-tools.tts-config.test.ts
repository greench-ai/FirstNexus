...
import { __testing, createFirstNexusTools } from "./FirstNexus-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/FirstNexus/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./FirstNexus-plugin-tools.js", () => ({
  resolveFirstNexusPluginToolsForOptions: () => [],
}));

vi.mock("./FirstNexus-tools.nodes-workspace-guard.js", () => ({
...
describe("createFirstNexusTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createFirstNexusTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
