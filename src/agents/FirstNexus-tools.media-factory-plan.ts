...
function hasExplicitImageModelConfig(config: FirstNexusConfig | undefined): boolean {
  return hasExplicitToolModelConfig(config?.agents?.defaults?.imageModel);
}

function hasExplicitPdfModelConfig(config: FirstNexusConfig | undefined): boolean {
  return (
