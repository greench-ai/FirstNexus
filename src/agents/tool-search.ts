...
type CatalogSource = "FirstNexus" | "mcp" | "client";
...
function buildModelScriptSource(code) {
  return "(async (FirstNexus, console) => {\n" + code + "\n})(FirstNexus, console)";
}
...
function buildControllerSource() {
  return (
    ...
    "});\n" +
    "const FirstNexus = Object.freeze({\n" +
    "  tools: Object.freeze({\n" +
...
async function runModelCode(code, timeoutMs) {
  ...
  Object.defineProperties(sandbox, {
    ...
    FirstNexus: { value: controller.FirstNexus, enumerable: true },
  });
...
const SESSION_CATALOGS_KEY = Symbol.for("FirstNexus.toolSearch.sessionCatalogs");
...
function readToolSearchConfig(config?: FirstNexusConfig): Record<string, unknown> {
...
export function resolveToolSearchConfig(config?: FirstNexusConfig): ToolSearchConfig {
...
function classifyTool(tool: CatalogTool): { source: CatalogSource; sourceName?: string } {
  ...
  if (pluginId) {
    return { source: "FirstNexus", sourceName: pluginId };
  }
  return { source: "FirstNexus", sourceName: "core" };
}
  ...
  return [
    {
      ...
      description:
        "Run JavaScript in an isolated Node subprocess with FirstNexus.tools.search, FirstNexus.tools.describe, and FirstNexus.tools.call for large tool catalogs.",
      parameters: Type.Object({
        code: Type.String({
          description:
            "JavaScript body for an async function. Use return to return the final value. The FirstNexus.tools bridge is available.",
        }),
      }),
      execute: async (
        toolCallId: string,
    ...
    },
    {
      name: TOOL_CALL_RAW_TOOL_NAME,
      label: "Tool Call",
      description: "Call a selected Tool Search catalog entry through FirstNexus.",
      parameters: Type.Object({
        id: Type.String({ description: "Tool search result id or tool name." }),
        args: Type.Optional(
