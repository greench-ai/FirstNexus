...
function resolveWatchPaths(workspaceDir: string, config?: FirstNexusConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: FirstNexusConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FirstNexusConfig }) {
