...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<NexusClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<NexusClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: NexusClawConfig): WebSearchConfig {
