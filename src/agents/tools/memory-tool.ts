...
function resolveMemoryToolContext(options: { config?: NexusClawConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: NexusClawConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: NexusClawConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: NexusClawConfig): MemoryCitationsMode {
