...
type CreateFirstNexusTools = typeof import("../FirstNexus-tools.js").createFirstNexusTools;
...
let createFirstNexusTools: CreateFirstNexusTools;
...
beforeAll(async () => {
  ...
  ({ createFirstNexusTools } = await import("../FirstNexus-tools.js"));
});
...
describe("message tool secret scoping", () => {
  ...
  it("forwards source reply delivery mode through createFirstNexusTools", () => {
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createFirstNexusTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
