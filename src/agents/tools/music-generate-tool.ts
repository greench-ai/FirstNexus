...
function hasExplicitMusicGenerationModelConfig(cfg?: FirstNexusConfig): boolean {
...
export function createMusicGenerateTool(options?: {
  ...
  return {
    ...
    description:
      "Generate music using configured providers. Generated tracks are saved under FirstNexus-managed media storage and delivered automatically as attachments.",
