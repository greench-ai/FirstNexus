...
// Keep the schema local to avoid a circular import through acp-spawn/FirstNexus-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: FirstNexusConfig }) {
