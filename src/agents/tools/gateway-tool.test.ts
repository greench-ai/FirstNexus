...
const {
  ...
  formatDoctorNonInteractiveHintMock: vi.fn(() => "Run: FirstNexus doctor --non-interactive"),
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: FirstNexus doctor --non-interactive");
