...
export function resolveCompactionReserveTokensFloor(cfg?: FirstNexusConfig): number {
...
export function resolveEffectiveCompactionMode(cfg?: FirstNexusConfig): AgentCompactionMode {
 ...
 * provider call (FirstNexus#75799).
 *
 ...
 * before the provider call) when FirstNexus or a plugin owns compaction:
 * `contextEngineInfo.ownsCompaction === true`, effective safeguard compaction,
 * or an active model that is silent-overflow-prone (FirstNexus#75799).
