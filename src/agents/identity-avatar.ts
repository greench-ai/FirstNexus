...
function resolveAvatarSource(cfg: NexusClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: NexusClawConfig, agentId: string): AgentAvatarResolution {
