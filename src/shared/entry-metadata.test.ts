...
describe("shared/entry-metadata", () => {
  it("prefers metadata emoji and homepage when present", () => {
    expect(
      resolveEmojiAndHomepage({
        metadata: { emoji: "🦀", homepage: " https://FirstNexus.ai " },
  ...
  it("falls back through frontmatter homepage aliases and drops blanks", () => {
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { emoji: "🙂", website: " https://docs.FirstNexus.ai " },
      }),
    ).toEqual({
      emoji: "🙂",
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { url: " https://FirstNexus.ai/install " },
      }),
    ).toEqual({
      homepage: "https://FirstNexus.ai/install",
    });
  });
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: {
          ...
          url: "https://FirstNexus.ai/install",
        },
      }),
    ).toStrictEqual({});
  });
