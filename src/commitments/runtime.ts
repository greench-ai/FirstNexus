...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: FirstNexusConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: FirstNexusConfig }> =
  [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: FirstNexusConfig }>,
