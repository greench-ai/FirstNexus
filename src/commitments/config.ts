...
export function resolveCommitmentsConfig(cfg?: FirstNexusConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: FirstNexusConfig): string {
