...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.NEXUSCLAW_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.NEXUSCLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.NEXUSCLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
