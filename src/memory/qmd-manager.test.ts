...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: NexusClawConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__nexusclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__nexusclawMcporterColdStartWarned;
  });
