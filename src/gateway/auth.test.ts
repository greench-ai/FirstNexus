...
describe("gateway auth", () => {
  ...
  it("resolves token/password from NEXUSCLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          NEXUSCLAW_GATEWAY_TOKEN: "env-token",
          NEXUSCLAW_GATEWAY_PASSWORD: "env-password",
    ...
    expect(
      resolveGatewayAuth({
        authConfig: {
          ...
          password: "${NEXUSCLAW_GATEWAY_PASSWORD}",
        },
        env: {
          NEXUSCLAW_GATEWAY_TOKEN: "env-token",
          NEXUSCLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides NEXUSCLAW_GATEWAY_PASSWORD", () => {
