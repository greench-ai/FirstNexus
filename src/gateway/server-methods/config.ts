...
import type { ConfigValidationIssue, FirstNexusConfig } from "../../config/types.FirstNexus.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: FirstNexusConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, getRuntimeConfig() and loadFirstNexusPlugins() (called inside
