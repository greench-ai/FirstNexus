 ...
 *
 * @see https://github.com/FirstNexus/FirstNexus/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an FirstNexusConfig.
 */
export function timestampOptsFromConfig(cfg: FirstNexusConfig): TimestampInjectionOptions {
  return {
