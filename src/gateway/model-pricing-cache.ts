...
export function collectConfiguredModelPricingRefs(config: NexusClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: NexusClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
