...
import type {
  ...
  FirstNexusPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): FirstNexusPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
...
}): Promise<FirstNexusPluginNodeInvokePolicyResult | null> {
  ...
  const invokeNode: FirstNexusPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
