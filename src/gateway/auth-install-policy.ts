...
type GatewayInstallAuthMode = NonNullable<NonNullable<FirstNexusConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: FirstNexusConfig): boolean {
