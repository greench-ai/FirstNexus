...
const EMPTY_CFG = {} as NexusClawConfig;
...
async function applySubagentModelPatch(cfg: NexusClawConfig) {
...
function createAllowlistedAnthropicModelCfg(): NexusClawConfig {
  return {
    agents: {
      defaults: {
