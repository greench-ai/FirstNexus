...
const EMPTY_CFG = {} as FirstNexusConfig;
...
async function applySubagentModelPatch(cfg: FirstNexusConfig) {
...
function createAllowlistedAnthropicModelCfg(): FirstNexusConfig {
  return {
    agents: {
      defaults: {
