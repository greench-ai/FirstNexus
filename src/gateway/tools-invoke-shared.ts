...
function resolveSessionKey(params: { cfg: FirstNexusConfig; input: ToolsInvokeInput }): string {
...
function resolveMemoryToolDisableReasons(cfg: FirstNexusConfig): string[] {
