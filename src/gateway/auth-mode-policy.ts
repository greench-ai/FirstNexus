...
export function hasAmbiguousGatewayAuthModeConfig(cfg: FirstNexusConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: FirstNexusConfig): void {
