...
export function hasAmbiguousGatewayAuthModeConfig(cfg: NexusClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: NexusClawConfig): void {
