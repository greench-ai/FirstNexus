...
function resolveDefaultStoreAgentId(cfg: FirstNexusConfig): string {
...
export function resolveSessionStoreAgentId(cfg: FirstNexusConfig, canonicalKey: string): string {
