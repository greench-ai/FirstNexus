...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.nexusclaw.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.nexusclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", NEXUSCLAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.nexusclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when NEXUSCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.nexusclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when NEXUSCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", NEXUSCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.nexusclaw.jbphoenix.plist",
    },
    {
      name: "prefers NEXUSCLAW_LAUNCHD_LABEL over NEXUSCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        NEXUSCLAW_PROFILE: "jbphoenix",
        NEXUSCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from NEXUSCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        NEXUSCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty NEXUSCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        NEXUSCLAW_PROFILE: "myprofile",
        NEXUSCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.nexusclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
