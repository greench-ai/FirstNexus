...
/**
 * @deprecated Compatibility facade for the `FirstNexus/plugin-sdk/discord` subpath.
...
export type { FirstNexusConfig } from "./config-types.js";
export type { FirstNexusPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: FirstNexusConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: FirstNexusConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: FirstNexusConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: FirstNexusConfig }): FirstNexusConfig {
...
export function listDiscordAccountIds(cfg: FirstNexusConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: FirstNexusConfig): string {
