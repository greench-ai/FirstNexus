...
import type { BrowserConfig, BrowserProfileConfig, FirstNexusConfig } from "../config/config.js";
import type { SsrFPolicy } from "../infra/net/ssrf.js";
import { resolvePreferredFirstNexusTmpDir } from "../infra/tmp-FirstNexus-dir.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

export const DEFAULT_NEXISCLAW_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_NEXISCLAW_BROWSER_COLOR = "#FF4500";
export const DEFAULT_NEXISCLAW_BROWSER_PROFILE_NAME = "FirstNexus";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "FirstNexus";
export const DEFAULT_BROWSER_ACTION_TIMEOUT_MS = 60_000;
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredFirstNexusTmpDir(), "uploads");
