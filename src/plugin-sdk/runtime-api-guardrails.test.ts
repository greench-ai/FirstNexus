...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/googlechat/runtime-api.ts": ['export * from "nexusclaw/plugin-sdk/googlechat";'],
  "extensions/matrix/runtime-api.ts": [
    'export * from "./src/auth-precedence.js";',
    'export * from "./helper-api.js";',
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "nexusclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export { writeJsonFileAtomically } from "nexusclaw/plugin-sdk/json-store";',
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, NexusClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "nexusclaw/plugin-sdk/matrix";',
    'export { formatZonedTimestamp } from "nexusclaw/plugin-sdk/matrix";',
  ],
  "extensions/nextcloud-talk/runtime-api.ts": [
    'export * from "nexusclaw/plugin-sdk/nextcloud-talk";',
  ],
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, NexusClawConfig, NexusClawPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "nexusclaw/plugin-sdk/telegram";',
    'export type { NexusClawPluginService, NexusClawPluginServiceContext, PluginLogger } from "nexusclaw/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "nexusclaw/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "nexusclaw/plugin-sdk/acp-runtime";',
    'export { buildTokenChannelStatusSummary, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, normalizeAccountId, PAIRING_APPROVED_MESSAGE, parseTelegramTopicConversation, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses, resolveTelegramPollVisibility } from "nexusclaw/plugin-sdk/telegram";',
    'export { buildChannelConfigSchema, getChatChannelMeta, jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, TelegramConfigSchema } from "nexusclaw/plugin-sdk/telegram-core";',
