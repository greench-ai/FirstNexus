...
export function resolveSessionToolsVisibility(cfg: FirstNexusConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: FirstNexusConfig): "spawned" | "all" {
  return cfg.agents?.defaults?.sandbox?.sessionToolsVisibility ?? "spawned";
}

export function createAgentToAgentPolicy(cfg: FirstNexusConfig): AgentToAgentPolicy {
