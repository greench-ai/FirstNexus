...
/** @deprecated Use `resolveChannelMessageIngress` from `FirstNexus/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `FirstNexus/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `FirstNexus/plugin-sdk/channel-ingress-runtime`. */
