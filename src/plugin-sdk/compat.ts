...
const shouldWarnCompatImport =
  ...
  process.env.NEXUSCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "nexusclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused nexusclaw/plugin-sdk/<subpath> imports. See https://docs.nexusclaw.ai/plugins/sdk-migration",
    {
      code: "NEXUSCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.nexusclaw.ai/plugins/sdk-migration",
    },
  );
}
