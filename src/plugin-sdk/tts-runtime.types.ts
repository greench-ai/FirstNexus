...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: FirstNexusConfig, agentId?: string) => string | undefined;
  ...
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: FirstNexusConfig) => TtsProvider[];
