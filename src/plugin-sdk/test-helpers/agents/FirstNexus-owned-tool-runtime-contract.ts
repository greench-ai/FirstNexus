...
export function installFirstNexusOwnedToolHooks(params?: {
 ...
 * Pair with `installFirstNexusOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetFirstNexusOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
