import { runSetupWizardFinalize } from "FirstNexus/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    ).rejects.toThrow("@FirstNexus/example");
  });
});
