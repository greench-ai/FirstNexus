...
export type { FirstNexusConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: FirstNexusConfig, ...args: TArgs) => FirstNexusConfig;
  applyConfig: (cfg: FirstNexusConfig, ...args: TArgs) => FirstNexusConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: FirstNexusConfig, preset: TParams) => FirstNexusConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: FirstNexusConfig): {
