...
type ChannelConfigAccessorParams<Config extends FirstNexusConfig = FirstNexusConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends FirstNexusConfig = FirstNexusConfig,
> = {
  sectionKey: string;
...
function setTopLevelChannelEnabledInConfigSection<Config extends FirstNexusConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends FirstNexusConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends FirstNexusConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
