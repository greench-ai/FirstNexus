...
export function createScopedAccountConfigAccessors<
  ResolvedAccount,
  Config extends NexusClawConfig = NexusClawConfig,
>(params: {
...
> {
  const base = {
    resolveAllowFrom: ({ cfg, accountId }: { cfg: NexusClawConfig; accountId?: string | null }) =>
      mapAllowFromEntries(
...
function setTopLevelChannelEnabledInConfigSection<Config extends NexusClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends NexusClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends NexusClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
