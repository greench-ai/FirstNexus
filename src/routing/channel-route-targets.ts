...
function listConfiguredChannelIds(cfg: FirstNexusConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: FirstNexusConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: FirstNexusConfig): ChannelRouteTarget[] {
