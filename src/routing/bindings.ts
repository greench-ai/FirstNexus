...
export function listBindings(cfg: NexusClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: NexusClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: NexusClawConfig) {
