...
export function listBindings(cfg: FirstNexusConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: FirstNexusConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: FirstNexusConfig) {
