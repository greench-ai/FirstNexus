...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FirstNexusConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FirstNexusConfig; env: NodeJS.ProcessEnv }): {
  cfg: FirstNexusConfig;
  changes: string[];
} {
