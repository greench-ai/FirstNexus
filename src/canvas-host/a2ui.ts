...
export const A2UI_PATH = "/__nexusclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__nexusclaw__/canvas";

export const CANVAS_WS_PATH = "/__nexusclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.nexusclawCanvasA2UIAction.postMessage(...)
  // - Android: window.nexusclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["nexusclawCanvasA2UIAction"];
  ...
  globalThis.NexusClaw = globalThis.NexusClaw ?? {};
  globalThis.NexusClaw.postMessage = postToNode;
  globalThis.NexusClaw.sendUserAction = sendUserAction;
  globalThis.nexusclawPostMessage = postToNode;
  globalThis.nexusclawSendUserAction = sendUserAction;
