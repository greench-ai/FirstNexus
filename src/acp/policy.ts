...
export function isAcpEnabledByPolicy(cfg: NexusClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: NexusClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: NexusClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: NexusClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: NexusClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: NexusClawConfig, agentId: string): boolean {
