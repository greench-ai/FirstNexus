...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: FirstNexusConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: FirstNexusConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: FirstNexusConfig; meta: SessionAcpMeta }): number {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: FirstNexusConfig }): Promise<void> {
