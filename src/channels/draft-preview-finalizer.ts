...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `FirstNexus/plugin-sdk/channel-message`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `FirstNexus/plugin-sdk/channel-message`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `FirstNexus/plugin-sdk/channel-message`.
 */
