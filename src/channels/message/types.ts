...
export type ChannelMessageSendTextContext<TConfig = FirstNexusConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = FirstNexusConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = FirstNexusConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendAttemptContext<TConfig = FirstNexusConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = FirstNexusConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = FirstNexusConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
