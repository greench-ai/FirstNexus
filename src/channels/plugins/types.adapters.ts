...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: NexusClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: NexusClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: NexusClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: NexusClawConfig;
    accountId: string;
    enabled: boolean;
  }) => NexusClawConfig;
  deleteAccount?: (params: { cfg: NexusClawConfig; accountId: string }) => NexusClawConfig;
  isEnabled?: (account: ResolvedAccount, cfg: NexusClawConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: NexusClawConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: NexusClawConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: NexusClawConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: NexusClawConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.nexusclaw.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: NexusClawConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: NexusClawConfig;
    nextCfg: NexusClawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: NexusClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: NexusClawConfig; accountId?: string | null }) =>
    | {
