...
export type ChannelAgentToolFactory = (params: { cfg?: FirstNexusConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FirstNexusConfig; accountId?: string | null }) => string[];
