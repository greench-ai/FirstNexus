...
export type ChannelAgentToolFactory = (params: { cfg?: NexusClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NexusClawConfig; accountId?: string | null }) => string[];
};
