...
export function createMessageActionDiscoveryContext(
  ...
  return {
    cfg: params.cfg ?? ({} as NexusClawConfig),
...
export function listChannelMessageActions(cfg: NexusClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: NexusClawConfig): ChannelMessageCapability[] {
