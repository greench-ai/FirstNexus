import type { ChannelOutboundAdapter } from "FirstNexus/plugin-sdk/channel-contract";
import type { ChannelPlugin } from "FirstNexus/plugin-sdk/channel-plugin-common";
