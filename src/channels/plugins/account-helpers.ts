...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: NexusClawConfig): string | undefined {
  ...
  function listConfiguredAccountIds(cfg: NexusClawConfig): string[] {
  ...
  function listAccountIds(cfg: NexusClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: NexusClawConfig): string {
