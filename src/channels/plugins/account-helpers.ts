...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: FirstNexusConfig): string | undefined {
  ...
  function listAccountIds(cfg: FirstNexusConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: FirstNexusConfig): string {
