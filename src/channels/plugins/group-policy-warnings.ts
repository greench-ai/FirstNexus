...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: FirstNexusConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: FirstNexusConfig }>(
  collector: WarningCollector<{ cfg: FirstNexusConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: FirstNexusConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: FirstNexusConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: FirstNexusConfig },
>(
  projectCfg: (cfg: FirstNexusConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: FirstNexusConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: FirstNexusConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: FirstNexusConfig },
>(params: {
  providerConfigPresent: (cfg: FirstNexusConfig) => boolean;
