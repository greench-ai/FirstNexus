...
import type { FirstNexusPackageManifest } from "../../plugins/manifest.js";
...
function resolveOfficialCatalogPaths(options: CatalogOptions): string[] {
  ...
  const packageRoots = [
    resolveFirstNexusPackageRootSync({ cwd: process.cwd() }),
    resolveFirstNexusPackageRootSync({ moduleUrl: import.meta.url }),
...
function toChannelMeta(params: {
  channel: NonNullable<FirstNexusPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
