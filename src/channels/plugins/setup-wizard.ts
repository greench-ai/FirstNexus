...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: NexusClawConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: NexusClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: NexusClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: NexusClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: NexusClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: NexusClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: NexusClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: NexusClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: NexusClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: NexusClawConfig) => NexusClawConfig;
