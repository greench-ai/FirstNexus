...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@nexusclaw", { botUsername: "nexusclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@nexusclaw args", {
        botUsername: "nexusclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@nexusclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "nexusclaw" })).toBe(
      "/help@otherbot",
    );
  });
