...
function createMatrixThreadCommandParams(commandBody: string, cfg: NexusClawConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: NexusClawConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
