...
type FirstNexusToolsRuntime = typeof import("../../agents/FirstNexus-tools.runtime.js");
...
const openClawToolsRuntimeLoader = createLazyImportLoader<FirstNexusToolsRuntime>(
  () => import("../../agents/FirstNexus-tools.runtime.js"),
);
...
function loadFirstNexusToolsRuntime(): Promise<FirstNexusToolsRuntime> {
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createFirstNexusTools } = await loadFirstNexusToolsRuntime();
