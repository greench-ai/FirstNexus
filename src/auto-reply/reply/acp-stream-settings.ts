...
function resolveAcpStreamCoalesceIdleMs(cfg: FirstNexusConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: FirstNexusConfig): number {
...
export function resolveAcpProjectionSettings(cfg: FirstNexusConfig): AcpProjectionSettings {
