...
function resolveAcpStreamCoalesceIdleMs(cfg: NexusClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: NexusClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: NexusClawConfig): AcpProjectionSettings {
