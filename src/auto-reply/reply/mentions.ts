...
function resolveMentionPatterns(cfg: FirstNexusConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: FirstNexusConfig | undefined, agentId?: string): RegExp[] {
