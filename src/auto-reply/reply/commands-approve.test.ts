...
function getDiscordExecApprovalApproversForTests(params: { cfg: FirstNexusConfig }): string[] {
...
function listConfiguredTelegramAccountIds(cfg: FirstNexusConfig): string[] {
