...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "FirstNexus.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by FirstNexus out-of-band. Treat it as authoritative metadata about the current message context.",
