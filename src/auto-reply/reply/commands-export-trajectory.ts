...
import {
  buildCurrentFirstNexusCliArgv,
  buildCurrentFirstNexusCliCommand,
} from "./commands-FirstNexus-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.FirstNexus.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentFirstNexusCliArgv(args),
    command: buildCurrentFirstNexusCliCommand(args),
    displayCommand: ["FirstNexus", ...args].join(" "),
    encodedRequest,
    request,
  };
}
