...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("FirstNexus.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("FirstNexus.contextEngineRegistryState");
