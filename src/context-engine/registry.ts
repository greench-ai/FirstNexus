...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("nexusclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("nexusclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: NexusClawConfig): Promise<ContextEngine> {
