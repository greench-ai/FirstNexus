...
import type { FirstNexusPluginService, FirstNexusPluginServiceContext } from "./types.js";
...
function createRegistry(
  services: FirstNexusPluginService[],
...
function expectServiceContext(
  ctx: FirstNexusPluginServiceContext,
...
function expectServiceLogger(ctx: FirstNexusPluginServiceContext) {
...
function expectServiceContexts(
  contexts: FirstNexusPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: FirstNexusPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: FirstNexusPluginServiceContext[] = [];
    ...
    const officialInstallContexts: FirstNexusPluginServiceContext[] = [];
    ...
    const untrustedContexts: FirstNexusPluginServiceContext[] = [];
    ...
    const spoofedContexts: FirstNexusPluginServiceContext[] = [];
