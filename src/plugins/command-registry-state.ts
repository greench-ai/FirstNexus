...
import type { NexusClawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = NexusClawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("nexusclaw.pluginCommandsState");
