...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.FirstNexus.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.FirstNexus.js").FirstNexusConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.FirstNexus.js").FirstNexusConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.FirstNexus.js").FirstNexusConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.FirstNexus.js").FirstNexusConfig;
    /**
