...
const mocks = vi.hoisted(() => ({
  loadFirstNexusPlugins: vi.fn<typeof import("../loader.js").loadFirstNexusPlugins>(),
...
function loadOptions(index = 0) {
  return requireRecord(mocks.loadFirstNexusPlugins.mock.calls[index]?.[0], `load options ${index}`);
}
...
vi.mock("../loader.js", () => ({
  loadFirstNexusPlugins: (...args: Parameters<typeof mocks.loadFirstNexusPlugins>) =>
    mocks.loadFirstNexusPlugins(...args),
  resolveCompatibleRuntimePluginRegistry: (
...
describe("ensurePluginRegistryLoaded", () => {
  ...
  beforeEach(() => {
    ...
    mocks.loadFirstNexusPlugins.mockReturnValue(createEmptyPluginRegistry());
    mocks.resolveRuntimePluginRegistry.mockImplementation(
      (...args: Parameters<typeof mocks.loadFirstNexusPlugins>) =>
        mocks.loadFirstNexusPlugins(...args),
    );
