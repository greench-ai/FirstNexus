...
function getConfigPath(config: FirstNexusConfig | undefined, path: string): unknown {
...
function setConfigPath(target: FirstNexusConfig, path: string, value: unknown): void {
