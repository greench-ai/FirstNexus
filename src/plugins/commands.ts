...
function listPluginInvocationKeys(command: NexusClawPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: NexusClawPluginCommandDefinition): string[] {
