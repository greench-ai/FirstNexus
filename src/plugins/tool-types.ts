...
export type FirstNexusPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type FirstNexusPluginToolContext = {
   ...
   * the local operator, installed plugin code, or a modified FirstNexus runtime.
   */
  activeModel?: FirstNexusPluginActiveModelContext;
  browser?: {
...
export type FirstNexusPluginToolFactory = (
  ctx: FirstNexusPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type FirstNexusPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type FirstNexusPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
