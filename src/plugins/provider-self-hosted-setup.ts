...
export function applyProviderDefaultModel(cfg: NexusClawConfig, modelRef: string): NexusClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: NexusClawConfig; modelId: string; modelRef: string; profileId: string } {
