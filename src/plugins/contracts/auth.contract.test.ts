...
import type { NexusClawPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("nexusclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("nexusclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("nexusclaw/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("nexusclaw/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("nexusclaw/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nexusclaw/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("nexusclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nexusclaw/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
...
function registerProviders(...plugins: Array<{ register(api: NexusClawPluginApi): void }>) {
