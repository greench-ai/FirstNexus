...
import { relinkFirstNexusPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: FirstNexusConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: FirstNexusConfig = {
    ...
    channels: channels as FirstNexusConfig["channels"],
  };
