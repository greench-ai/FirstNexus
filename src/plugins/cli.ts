...
import type { FirstNexusPluginCliCommandDescriptor } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("FirstNexus.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<FirstNexusConfig | null> => {
