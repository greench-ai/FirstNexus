...
export function applyGoogleGeminiModelDefault(cfg: NexusClawConfig): {
...
export function applyOpenAIProviderConfig(cfg: NexusClawConfig): NexusClawConfig {
...
export function applyOpenAIConfig(cfg: NexusClawConfig): NexusClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: NexusClawConfig): {
  next: NexusClawConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: NexusClawConfig): {
  next: NexusClawConfig;
  changed: boolean;
} {
