...
function loadPluginHostHookSessionEntry(params: { cfg: FirstNexusConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: FirstNexusConfig, pluginId: string): boolean {
