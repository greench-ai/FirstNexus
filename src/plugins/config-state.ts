...
} & PluginActivationConfigSourceLike<FirstNexusConfig>;
...
const hasExplicitMemorySlot = (plugins?: FirstNexusConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: FirstNexusConfig["plugins"]) =>
  Boolean(
    plugins?.entries &&
    Object.prototype.hasOwnProperty.call(plugins.entries, defaultSlotIdForKey("memory")),
  );

export const hasExplicitPluginConfig = (plugins?: FirstNexusConfig["plugins"]) =>
