...
import type { FirstNexusPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: FirstNexusPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): FirstNexusPluginConfigSchema {
  return {
