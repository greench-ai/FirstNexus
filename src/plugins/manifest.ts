...
export const PLUGIN_MANIFEST_FILENAME = "nexusclaw.plugin.json";
...
// package.json "nexusclaw" metadata (used for setup/catalog)
...
export type NexusClawPackageStartup = {
  /**
...
export type NexusClawPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: NexusClawPackageStartup;
};
...
): NexusClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
