...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverFirstNexusPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverFirstNexusPlugins: mocks.discoverFirstNexusPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    manifestPath: `/tmp/${overrides.id}/FirstNexus.plugin.json`,
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/FirstNexus.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverFirstNexusPlugins.mockReset();
    mocks.discoverFirstNexusPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
