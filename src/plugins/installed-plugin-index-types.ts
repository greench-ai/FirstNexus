...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by FirstNexus from plugin manifests, install records, and config policy. Use `FirstNexus plugins registry --refresh`, `FirstNexus plugins install/update/uninstall`, or `FirstNexus plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored FirstNexus.install metadata. This describes catalog/package
