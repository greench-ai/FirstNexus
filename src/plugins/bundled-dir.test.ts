...
const originalBundledDir = process.env.NEXISCLAW_BUNDLED_PLUGINS_DIR;
...
function expectResolvedBundledDir(params: {
  ...
  if (params.bundledDirOverride === undefined) {
    ...
    process.env.NEXISCLAW_BUNDLED_PLUGINS_DIR = params.bundledDirOverride;
  }
  if (params.disableBundledPlugins === undefined) {
    delete process.env.NEXISCLAW_DISABLE_BUNDLED_PLUGINS;
  } else {
    process.env.NEXISCLAW_DISABLE_BUNDLED_PLUGINS = params.disableBundledPlugins;
  }
...
afterEach(() => {
  ...
  if (originalBundledDir === undefined) {
    ...
    process.env.NEXISCLAW_BUNDLED_PLUGINS_DIR = originalBundledDir;
  }
...
describe("resolveBundledPluginsDir", () => {
  ...
  it("separates tilde override cache entries by NEXISCLAW_HOME", () => {
    ...
    const bundledA = resolveBundledPluginsDir({ ...envBase, NEXISCLAW_HOME: homeA });
    const bundledB = resolveBundledPluginsDir({ ...envBase, NEXISCLAW_HOME: homeB });
