...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/FirstNexus-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/FirstNexus-weixin@2.3.7",
    installPath:
      "/tmp/FirstNexus-test-home/.FirstNexus/npm/node_modules/@tencent-weixin/FirstNexus-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverFirstNexusPlugins: discoverSpy }));
