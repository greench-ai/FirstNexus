...
import type {
  ...
  NexusClawPluginApi,
  NexusClawPluginChannelRegistration,
  NexusClawPluginCliRegistrar,
  NexusClawPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  NexusClawPluginHttpRouteAuth,
  NexusClawPluginHttpRouteMatch,
  NexusClawPluginHttpRouteHandler,
  NexusClawPluginHttpRouteParams,
  NexusClawPluginHookOptions,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: NexusClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: NexusClawPluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  pluginName?: string;
  service: NexusClawPluginService;
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: NexusClawPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: NexusClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: NexusClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: NexusClawPluginHookOptions | undefined,
    config: NexusClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: NexusClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: NexusClawPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as NexusClawPluginChannelRegistration).plugin === "object"
        ? (registration as NexusClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: NexusClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: NexusClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: NexusClawPluginCommandDefinition) => {
