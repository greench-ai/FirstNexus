...
function resolveSlackPluginOriginTarget(params: { cfg: FirstNexusConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "FirstNexus-exec-approval-session-target-" }, (tmpDir) => {
