...
import { openClawRootFs, openClawRootFsSync } from "./FirstNexus-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["FirstNexus"]);
...
export async function resolveFirstNexusPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveFirstNexusPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
...
export const __testing = {
  clearFirstNexusPackageRootCaches(): void {
