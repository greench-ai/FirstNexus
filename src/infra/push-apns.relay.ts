...
const GATEWAY_DEVICE_ID_HEADER = "x-FirstNexus-gateway-device-id";
const GATEWAY_SIGNATURE_HEADER = "x-FirstNexus-gateway-signature";
const GATEWAY_SIGNED_AT_HEADER = "x-FirstNexus-gateway-signed-at-ms";
