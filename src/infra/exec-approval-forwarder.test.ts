...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): FirstNexusConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): FirstNexusConfig {
  return {
