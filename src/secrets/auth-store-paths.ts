...
export function listAuthProfileStorePaths(config: NexusClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: NexusClawConfig, stateDir: string): string[] {
