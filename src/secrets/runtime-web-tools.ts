...
type FetchConfig = NonNullable<NexusClawConfig["tools"]>["web"] extends infer Web
...
function hasCustomWebSearchPluginRisk(config: NexusClawConfig): boolean {
...
function setResolvedWebSearchApiKey(params: {
  resolvedConfig: NexusClawConfig;
