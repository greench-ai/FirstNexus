...
function resolveResolutionLimits(config: NexusClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: NexusClawConfig): SecretProviderConfig {
