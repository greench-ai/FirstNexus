...
function resolveResolutionLimits(config: FirstNexusConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: FirstNexusConfig): SecretProviderConfig {
