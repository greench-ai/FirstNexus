import type { FirstNexusConfig, HookConfig } from "../config/config.js";
...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "FirstNexus-bundled": {
    ...
    canOverride: ["FirstNexus-bundled"],
    canBeOverriddenBy: ["FirstNexus-managed", "FirstNexus-plugin"],
  },
  "FirstNexus-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["FirstNexus-bundled", "FirstNexus-plugin"],
    canBeOverriddenBy: ["FirstNexus-managed"],
  },
  "FirstNexus-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["FirstNexus-bundled", "FirstNexus-managed", "FirstNexus-plugin"],
    canBeOverriddenBy: ["FirstNexus-managed"],
  },
  "FirstNexus-workspace": {
    ...
    canOverride: ["FirstNexus-workspace"],
    canBeOverriddenBy: ["FirstNexus-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "FirstNexus-plugin") {
    return { enabled: true };
  }
