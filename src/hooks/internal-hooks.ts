/**
 * Hook system for NexusClaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __nexusclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__nexusclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
