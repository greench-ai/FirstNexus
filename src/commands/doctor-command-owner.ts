...
function resolveConfiguredCommandOwners(cfg: FirstNexusConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: FirstNexusConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: FirstNexusConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("FirstNexus config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
