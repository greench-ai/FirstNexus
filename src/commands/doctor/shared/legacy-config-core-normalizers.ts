...
function hasConfiguredChannels(cfg: FirstNexusConfig): boolean {
...
export function normalizeLegacyCommandsConfig(
  ...
  return {
    ...cfg,
    commands: commands as FirstNexusConfig["commands"],
  };
}
...
export function normalizeLegacyBrowserConfig(
  ...
  return {
    ...cfg,
    browser: browser as FirstNexusConfig["browser"],
  };
}
...
type ModelProviderEntry = Partial<
  NonNullable<NonNullable<FirstNexusConfig["models"]>["providers"]>[string]
>;
type ModelsConfigPatch = Partial<NonNullable<FirstNexusConfig["models"]>>;
...
export function normalizeLegacyRuntimeModelRefs(
  ...
  return changed
    ? {
        ...cfg,
        agents: nextAgents as FirstNexusConfig["agents"],
      }
    : cfg;
}
...
export function normalizeLegacyOpenAICodexModelsAddMetadata(
  ...
  return {
    ...
    models: {
      ...rawModels,
      providers: nextProviders as NonNullable<FirstNexusConfig["models"]>["providers"],
    },
  };
}
...
export function normalizeLegacyNanoBananaSkill(
  ...
  if (!hasGoogleApiKey && legacyApiKey) {
    ...
    rawModels.providers = rawProviders as NonNullable<FirstNexusConfig["models"]>["providers"];
    next = {
      ...next,
      models: rawModels as FirstNexusConfig["models"],
    };
    changes.push(
...
export function normalizeLegacyMediaProviderOptions(
  ...
  return {
    ...
    tools: {
      ...cfg.tools,
      media: nextMedia as NonNullable<FirstNexusConfig["tools"]>["media"],
    },
  };
}
