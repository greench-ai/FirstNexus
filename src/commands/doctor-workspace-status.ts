...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("FirstNexus tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("FirstNexus tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: FirstNexusConfig) {
