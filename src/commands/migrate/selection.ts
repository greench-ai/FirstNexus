...
export const MIGRATION_SELECTION_TOGGLE_ALL_ON = "__FirstNexus_migrate_toggle_all_on__";
export const MIGRATION_SELECTION_TOGGLE_ALL_OFF = "__FirstNexus_migrate_toggle_all_off__";
export const MIGRATION_SELECTION_SKIP = "__FirstNexus_migrate_skip_for_now__";
