...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set NEXUSCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `nexusclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control NexusClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
