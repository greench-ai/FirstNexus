...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://FirstNexus.local")).toBe("https://FirstNexus.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://FirstNexus.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: FirstNexus security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://FirstNexus.local" },
      ...
      { Item: "Security", Value: "Run: FirstNexus security audit --deep" },
