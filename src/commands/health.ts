...
const resolveHeartbeatSummary = (cfg: FirstNexusConfig, agentId: string) =>
  resolveHeartbeatSummaryForAgent(cfg, agentId);

const resolveAgentOrder = (cfg: FirstNexusConfig) => {
...
async function readBestEffortHealthConfig(): Promise<FirstNexusConfig> {
