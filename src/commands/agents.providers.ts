...
function resolveDefaultAccountId(cfg: NexusClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: NexusClawConfig): boolean {
...
export function summarizeBindings(cfg: NexusClawConfig, bindings: AgentBinding[]): string[] {
