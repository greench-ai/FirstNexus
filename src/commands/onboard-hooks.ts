...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.nexusclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("nexusclaw hooks list")}`,
      `  ${formatCliCommand("nexusclaw hooks enable <name>")}`,
      `  ${formatCliCommand("nexusclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
