...
const SANDBOX_EXAMPLES = {
  main: [
    ["nexusclaw sandbox list", "List all sandbox containers."],
    ["nexusclaw sandbox list --browser", "List only browser containers."],
    ["nexusclaw sandbox recreate --all", "Recreate all containers."],
    ["nexusclaw sandbox recreate --session main", "Recreate a specific session."],
    ["nexusclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["nexusclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["nexusclaw sandbox list", "List all sandbox containers."],
    ["nexusclaw sandbox list --browser", "List only browser containers."],
    ["nexusclaw sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["nexusclaw sandbox recreate --all", "Recreate all containers."],
    ["nexusclaw sandbox recreate --session main", "Recreate a specific session."],
    ["nexusclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["nexusclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["nexusclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["nexusclaw sandbox explain", "Show effective sandbox config."],
    ["nexusclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["nexusclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["nexusclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.nexusclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
