    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["nexusclaw channels list", "List configured channels and auth profiles."],
          ["nexusclaw channels status --probe", "Run channel status checks and probes."],
          [
            "nexusclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["nexusclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.nexusclaw.ai/cli/channels",
        )}\n`,
    );
