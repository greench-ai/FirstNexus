...
export async function registerChannelsCli(
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["FirstNexus channels list", "List configured channels."],
          ["FirstNexus channels list --all", "Show configured, bundled, and installable channels."],
          ["FirstNexus channels add", "Open guided channel setup."],
          ["FirstNexus channels status --probe", "Run channel status checks and probes."],
          [
            "FirstNexus channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["FirstNexus channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.FirstNexus.ai/cli/channels",
        )}\n`,
    );
  ...
  const addCommand = channels
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["FirstNexus channels add", "Open guided setup for available chat channels."],
          [
            "FirstNexus channels add --channel telegram --token <token>",
            "Add or update Telegram non-interactively.",
          ],
          ["FirstNexus channels list --all", "Find channel ids before using --channel."],
        ])}\n`,
    )
    .option("--channel <name>", `Channel (${channelNames})`)
