      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["nexusclaw gateway run", "Run the gateway in the foreground."],
            ["nexusclaw gateway status", "Show service status and probe reachability."],
            ["nexusclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["nexusclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.nexusclaw.ai/cli/gateway")}\n`,
      ),
  );
