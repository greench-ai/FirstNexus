...
describe("skills-cli", () => {
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("FirstNexus skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("FirstNexus skills install");
    });
    ...
    it("shows API key storage guidance for the active config path", () => {
      ...
      expect(output).toContain("NEXISCLAW_CONFIG_PATH");
      expect(output).toContain("default: ~/.FirstNexus/FirstNexus.json");
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("FirstNexus skills update");
    });
