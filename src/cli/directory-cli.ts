    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["FirstNexus directory self --channel slack", "Show the connected account identity."],
          [
            'FirstNexus directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["FirstNexus directory groups list --channel discord", "List available groups/channels."],
          [
            "FirstNexus directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.FirstNexus.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
